# app/llm/platform_clients/catalystwan_client.py
# Auto-generated – DO NOT EDIT
import catalystwan.session as _sdk

class CatalystwanClient:
    """Thin wrapper around `APIEndpointClient` with fuzzy attribute lookup."""

    def __init__(self, **kwargs):
        self._sdk = _sdk.APIEndpointClient(**kwargs)
