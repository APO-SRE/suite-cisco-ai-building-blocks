...
if TYPE_CHECKING:
    from ..models.schema_assert_config_static_default_route_exists_data import (
        SchemaAssertConfigStaticDefaultRouteExistsData,
    )
    from ..models.schema_path_path_id import SchemaPathPathId


T = TypeVar("T", bound="SchemaAssertStaticDefaultRouteExists")


@_attrs_define
class SchemaAssertStaticDefaultRouteExists:
    ...
    Attributes:
        ...
        category (Union[Unset, ModelsAssertCategoryType]): AssertCategoryType specifies the various kinds of assertion
            categories.
        config (Union[Unset, SchemaAssertConfigStaticDefaultRouteExistsData]): Description not available
    ...
    config: Union[Unset, "SchemaAssertConfigStaticDefaultRouteExistsData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config: Union[Unset, SchemaAssertConfigStaticDefaultRouteExistsData]
        if isinstance(_config, Unset):
            config = UNSET
        else:
            config = SchemaAssertConfigStaticDefaultRouteExistsData.from_dict(_config)
        ...
        schema_assert_static_default_route_exists = cls(
        ...
        schema_assert_static_default_route_exists.additional_properties = d
        return schema_assert_static_default_route_exists
