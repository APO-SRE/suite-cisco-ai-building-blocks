...
if TYPE_CHECKING:
    from ..models.schema_assert_config_bgp_peer_established_data import SchemaAssertConfigBgpPeerEstablishedData
    from ..models.schema_path_path_id import SchemaPathPathId


T = TypeVar("T", bound="SchemaAssertBgpPeerEstablished")


@_attrs_define
class SchemaAssertBgpPeerEstablished:
    ...
    Attributes:
        ...
        category (Union[Unset, ModelsAssertCategoryType]): AssertCategoryType specifies the various kinds of assertion
            categories.
        config (Union[Unset, SchemaAssertConfigBgpPeerEstablishedData]): Description not available
    ...
    config: Union[Unset, "SchemaAssertConfigBgpPeerEstablishedData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config: Union[Unset, SchemaAssertConfigBgpPeerEstablishedData]
        if isinstance(_config, Unset):
            config = UNSET
        else:
            config = SchemaAssertConfigBgpPeerEstablishedData.from_dict(_config)
        ...
        schema_assert_bgp_peer_established = cls(
        ...
        schema_assert_bgp_peer_established.additional_properties = d
        return schema_assert_bgp_peer_established
