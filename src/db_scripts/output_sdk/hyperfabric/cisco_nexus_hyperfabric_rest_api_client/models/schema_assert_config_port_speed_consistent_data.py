...
T = TypeVar("T", bound="SchemaAssertConfigPortSpeedConsistentData")


@_attrs_define
class SchemaAssertConfigPortSpeedConsistentData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        schema_assert_config_port_speed_consistent_data = cls(
            fabric_id=fabric_id,
        ...
        schema_assert_config_port_speed_consistent_data.additional_properties = d
        return schema_assert_config_port_speed_consistent_data
