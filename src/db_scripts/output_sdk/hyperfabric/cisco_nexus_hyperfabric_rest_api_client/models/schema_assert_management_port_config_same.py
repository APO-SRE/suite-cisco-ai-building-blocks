...
if TYPE_CHECKING:
    from ..models.schema_assert_config_management_port_config_data import SchemaAssertConfigManagementPortConfigData
    from ..models.schema_management_state import SchemaManagementState
    from ..models.schema_path_path_id import SchemaPathPathId


T = TypeVar("T", bound="SchemaAssertManagementPortConfigSame")


@_attrs_define
class SchemaAssertManagementPortConfigSame:
    ...
    Attributes:
        ...
        category (Union[Unset, ModelsAssertCategoryType]): AssertCategoryType specifies the various kinds of assertion
            categories.
        config (Union[Unset, SchemaAssertConfigManagementPortConfigData]): Description not available
        ...
        operational_mgmt_port_state (Union[Unset, SchemaManagementState]): Description not available
    ...
    config: Union[Unset, "SchemaAssertConfigManagementPortConfigData"] = UNSET
    ...
    operational_mgmt_port_state: Union[Unset, "SchemaManagementState"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        operational_mgmt_port_state: Union[Unset, dict[str, Any]] = UNSET
        if not isinstance(self.operational_mgmt_port_state, Unset):
            operational_mgmt_port_state = self.operational_mgmt_port_state.to_dict()
        ...
        if operational_mgmt_port_state is not UNSET:
            field_dict["operationalMgmtPortState"] = operational_mgmt_port_state
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config: Union[Unset, SchemaAssertConfigManagementPortConfigData]
        if isinstance(_config, Unset):
            config = UNSET
        else:
            config = SchemaAssertConfigManagementPortConfigData.from_dict(_config)
        ...
        _operational_mgmt_port_state = d.pop("operationalMgmtPortState", UNSET)
        operational_mgmt_port_state: Union[Unset, SchemaManagementState]
        if isinstance(_operational_mgmt_port_state, Unset):
            operational_mgmt_port_state = UNSET
        else:
            operational_mgmt_port_state = SchemaManagementState.from_dict(_operational_mgmt_port_state)
        ...
        schema_assert_management_port_config_same = cls(
            ...
            operational_mgmt_port_state=operational_mgmt_port_state,
            ready_to_latch_at=ready_to_latch_at,
        )

        schema_assert_management_port_config_same.additional_properties = d
        return schema_assert_management_port_config_same
