...
if TYPE_CHECKING:
    from ..models.schema_assert_config_port_speed_consistent_data import SchemaAssertConfigPortSpeedConsistentData
    from ..models.schema_path_path_id import SchemaPathPathId


T = TypeVar("T", bound="SchemaAssertPortSpeedConsistent")


@_attrs_define
class SchemaAssertPortSpeedConsistent:
    ...
    Attributes:
        ...
        category (Union[Unset, ModelsAssertCategoryType]): AssertCategoryType specifies the various kinds of assertion
            categories.
        config (Union[Unset, SchemaAssertConfigPortSpeedConsistentData]): Description not available
    ...
    config: Union[Unset, "SchemaAssertConfigPortSpeedConsistentData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config: Union[Unset, SchemaAssertConfigPortSpeedConsistentData]
        if isinstance(_config, Unset):
            config = UNSET
        else:
            config = SchemaAssertConfigPortSpeedConsistentData.from_dict(_config)
        ...
        schema_assert_port_speed_consistent = cls(
        ...
        schema_assert_port_speed_consistent.additional_properties = d
        return schema_assert_port_speed_consistent
