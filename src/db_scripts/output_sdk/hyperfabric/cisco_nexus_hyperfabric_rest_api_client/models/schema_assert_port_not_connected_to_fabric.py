...
if TYPE_CHECKING:
    from ..models.schema_assert_config_not_connected_to_fabric_data import SchemaAssertConfigNotConnectedToFabricData
    from ..models.schema_path_path_id import SchemaPathPathId


T = TypeVar("T", bound="SchemaAssertPortNotConnectedToFabric")


@_attrs_define
class SchemaAssertPortNotConnectedToFabric:
    ...
    Attributes:
        ...
        category (Union[Unset, ModelsAssertCategoryType]): AssertCategoryType specifies the various kinds of assertion
            categories.
        config (Union[Unset, SchemaAssertConfigNotConnectedToFabricData]): Description not available
    ...
    config: Union[Unset, "SchemaAssertConfigNotConnectedToFabricData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.schema_assert_config_not_connected_to_fabric_data import (
        ...
        config: Union[Unset, SchemaAssertConfigNotConnectedToFabricData]
        if isinstance(_config, Unset):
            config = UNSET
        else:
            config = SchemaAssertConfigNotConnectedToFabricData.from_dict(_config)
        ...
        schema_assert_port_not_connected_to_fabric = cls(
        ...
        schema_assert_port_not_connected_to_fabric.additional_properties = d
        return schema_assert_port_not_connected_to_fabric
