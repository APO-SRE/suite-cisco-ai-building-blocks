...
T = TypeVar("T", bound="SchemaAssertConfigVlanHasTrafficData")


@_attrs_define
class SchemaAssertConfigVlanHasTrafficData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        schema_assert_config_vlan_has_traffic_data = cls(
            fabric_id=fabric_id,
        ...
        schema_assert_config_vlan_has_traffic_data.additional_properties = d
        return schema_assert_config_vlan_has_traffic_data
