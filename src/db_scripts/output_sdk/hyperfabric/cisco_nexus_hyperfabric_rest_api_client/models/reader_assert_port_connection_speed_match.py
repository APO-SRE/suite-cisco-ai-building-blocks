...
T = TypeVar("T", bound="ReaderAssertPortConnectionSpeedMatch")


@_attrs_define
class ReaderAssertPortConnectionSpeedMatch:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reader_assert_port_connection_speed_match = cls(
        ...
        reader_assert_port_connection_speed_match.additional_properties = d
        return reader_assert_port_connection_speed_match
