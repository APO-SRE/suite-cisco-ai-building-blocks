...
if TYPE_CHECKING:
    from ..models.schema_assert_config_connected_port_speeds_match_data import (
        SchemaAssertConfigConnectedPortSpeedsMatchData,
    )
    from ..models.schema_path_path_id import SchemaPathPathId


T = TypeVar("T", bound="SchemaAssertPortConnectionSpeedMatch")


@_attrs_define
class SchemaAssertPortConnectionSpeedMatch:
    ...
    Attributes:
        ...
        category (Union[Unset, ModelsAssertCategoryType]): AssertCategoryType specifies the various kinds of assertion
            categories.
        config (Union[Unset, SchemaAssertConfigConnectedPortSpeedsMatchData]): Description not available
        id (Union[Unset, SchemaPathPathId]): PathId identifies the specific "schema coordinates" identifier of an object
            in the schema tree.
        local_port_speed (Union[Unset, int]): Description not available
        ...
        remote_port_speed (Union[Unset, int]): Description not available
    """

    assert_state: Union[Unset, ModelsAssertStateType] = UNSET
    category: Union[Unset, ModelsAssertCategoryType] = UNSET
    config: Union[Unset, "SchemaAssertConfigConnectedPortSpeedsMatchData"] = UNSET
    id: Union[Unset, "SchemaPathPathId"] = UNSET
    local_port_speed: Union[Unset, int] = UNSET
    ...
    remote_port_speed: Union[Unset, int] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        remote_port_speed = self.remote_port_speed
        ...
        if remote_port_speed is not UNSET:
            field_dict["remotePortSpeed"] = remote_port_speed
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config: Union[Unset, SchemaAssertConfigConnectedPortSpeedsMatchData]
        if isinstance(_config, Unset):
            config = UNSET
        else:
            config = SchemaAssertConfigConnectedPortSpeedsMatchData.from_dict(_config)
        ...
        remote_port_speed = d.pop("remotePortSpeed", UNSET)

        schema_assert_port_connection_speed_match = cls(
            ...
            remote_port_speed=remote_port_speed,
        )

        schema_assert_port_connection_speed_match.additional_properties = d
        return schema_assert_port_connection_speed_match
