...
T = TypeVar("T", bound="SchemaAssertConfigDeviceResourceUsageBelowThresholdData")


@_attrs_define
class SchemaAssertConfigDeviceResourceUsageBelowThresholdData:
    """Description not available

    Attributes:
        cpu_threshold (Union[Unset, float]): Description not available
        disk_threshold (Union[Unset, float]): Description not available
        ...
        memory_threshold (Union[Unset, float]): Description not available
        org_id (Union[Unset, str]): Description not available
    """

    cpu_threshold: Union[Unset, float] = UNSET
    disk_threshold: Union[Unset, float] = UNSET
    ...
    memory_threshold: Union[Unset, float] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if cpu_threshold is not UNSET:
            field_dict["cpuThreshold"] = cpu_threshold
        if disk_threshold is not UNSET:
            field_dict["diskThreshold"] = disk_threshold
        ...
        if memory_threshold is not UNSET:
            field_dict["memoryThreshold"] = memory_threshold
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        cpu_threshold = d.pop("cpuThreshold", UNSET)

        disk_threshold = d.pop("diskThreshold", UNSET)
        ...
        memory_threshold = d.pop("memoryThreshold", UNSET)

        org_id = d.pop("orgId", UNSET)

        schema_assert_config_device_resource_usage_below_threshold_data = cls(
        ...
        schema_assert_config_device_resource_usage_below_threshold_data.additional_properties = d
        return schema_assert_config_device_resource_usage_below_threshold_data
