...
T = TypeVar("T", bound="ReaderAssertPortNotConnectedToFabric")


@_attrs_define
class ReaderAssertPortNotConnectedToFabric:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reader_assert_port_not_connected_to_fabric = cls(
        ...
        reader_assert_port_not_connected_to_fabric.additional_properties = d
        return reader_assert_port_not_connected_to_fabric
