...
T = TypeVar("T", bound="SchemaAssertConfigLinkDownData")


@_attrs_define
class SchemaAssertConfigLinkDownData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        schema_assert_config_link_down_data = cls(
            fabric_id=fabric_id,
        ...
        schema_assert_config_link_down_data.additional_properties = d
        return schema_assert_config_link_down_data
