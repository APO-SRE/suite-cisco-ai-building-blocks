...
T = TypeVar("T", bound="ReaderAssertStaticDefaultRouteExists")


@_attrs_define
class ReaderAssertStaticDefaultRouteExists:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reader_assert_static_default_route_exists = cls(
        ...
        reader_assert_static_default_route_exists.additional_properties = d
        return reader_assert_static_default_route_exists
