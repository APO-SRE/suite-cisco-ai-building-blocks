...
T = TypeVar("T", bound="ReaderAssertPortLinkDown")


@_attrs_define
class ReaderAssertPortLinkDown:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reader_assert_port_link_down = cls(
        ...
        reader_assert_port_link_down.additional_properties = d
        return reader_assert_port_link_down
