...
T = TypeVar("T", bound="AuthCreateBearerTokensResponse")


@_attrs_define
class AuthCreateBearerTokensResponse:
    """Create a new bearer token. Currently only a single bearer token can be created at a time.

    Attributes:
        tokens (Union[Unset, list['AuthBearerToken']]): The newly created tokens.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        auth_create_bearer_tokens_response = cls(
            tokens=tokens,
        )

        auth_create_bearer_tokens_response.additional_properties = d
        return auth_create_bearer_tokens_response
