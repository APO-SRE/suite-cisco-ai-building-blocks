...
if TYPE_CHECKING:
    from ..models.schema_assert_config_expected_neighbor_data import SchemaAssertConfigExpectedNeighborData
    from ..models.schema_path_path_id import SchemaPathPathId


T = TypeVar("T", bound="SchemaAssertPortExpectedNeighbor")


@_attrs_define
class SchemaAssertPortExpectedNeighbor:
    ...
    Attributes:
        ...
        category (Union[Unset, ModelsAssertCategoryType]): AssertCategoryType specifies the various kinds of assertion
            categories.
        config (Union[Unset, SchemaAssertConfigExpectedNeighborData]): Description not available
    ...
    config: Union[Unset, "SchemaAssertConfigExpectedNeighborData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config: Union[Unset, SchemaAssertConfigExpectedNeighborData]
        if isinstance(_config, Unset):
            config = UNSET
        else:
            config = SchemaAssertConfigExpectedNeighborData.from_dict(_config)
        ...
        schema_assert_port_expected_neighbor = cls(
        ...
        schema_assert_port_expected_neighbor.additional_properties = d
        return schema_assert_port_expected_neighbor
