...
T = TypeVar("T", bound="SchemaAssertConfigConnectedToCloudData")


@_attrs_define
class SchemaAssertConfigConnectedToCloudData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        schema_assert_config_connected_to_cloud_data = cls(
            fabric_id=fabric_id,
        ...
        schema_assert_config_connected_to_cloud_data.additional_properties = d
        return schema_assert_config_connected_to_cloud_data
