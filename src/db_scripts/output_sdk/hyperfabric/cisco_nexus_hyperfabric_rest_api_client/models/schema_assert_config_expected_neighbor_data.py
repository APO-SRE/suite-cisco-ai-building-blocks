...
T = TypeVar("T", bound="SchemaAssertConfigExpectedNeighborData")


@_attrs_define
class SchemaAssertConfigExpectedNeighborData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        schema_assert_config_expected_neighbor_data = cls(
            fabric_id=fabric_id,
        ...
        schema_assert_config_expected_neighbor_data.additional_properties = d
        return schema_assert_config_expected_neighbor_data
