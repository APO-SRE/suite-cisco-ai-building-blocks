...
T = TypeVar("T", bound="ReaderAssertBgpPeerEstablished")


@_attrs_define
class ReaderAssertBgpPeerEstablished:
    ...
    Attributes:
        ...
        peer_remote_as (Union[Unset, str]): Description not available
    ...
    peer_remote_as: Union[Unset, str] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reader_assert_bgp_peer_established = cls(
        ...
        reader_assert_bgp_peer_established.additional_properties = d
        return reader_assert_bgp_peer_established
