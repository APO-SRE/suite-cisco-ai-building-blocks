...
T = TypeVar("T", bound="ConfigLatchAssertionsRequest")


@_attrs_define
class ConfigLatchAssertionsRequest:
    """Latch one or more assertions.

    Attributes:
        assertions (Union[Unset, list['ConfigAssertion']]): The list of assertions to be latched.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config_latch_assertions_request = cls(
            assertions=assertions,
        )

        config_latch_assertions_request.additional_properties = d
        return config_latch_assertions_request
