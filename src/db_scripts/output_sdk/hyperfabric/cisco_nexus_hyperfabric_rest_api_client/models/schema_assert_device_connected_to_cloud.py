...
if TYPE_CHECKING:
    from ..models.schema_assert_config_connected_to_cloud_data import SchemaAssertConfigConnectedToCloudData
    from ..models.schema_path_path_id import SchemaPathPathId


T = TypeVar("T", bound="SchemaAssertDeviceConnectedToCloud")


@_attrs_define
class SchemaAssertDeviceConnectedToCloud:
    ...
    Attributes:
        ...
        category (Union[Unset, ModelsAssertCategoryType]): AssertCategoryType specifies the various kinds of assertion
            categories.
        config (Union[Unset, SchemaAssertConfigConnectedToCloudData]): Description not available
    ...
    config: Union[Unset, "SchemaAssertConfigConnectedToCloudData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config: Union[Unset, SchemaAssertConfigConnectedToCloudData]
        if isinstance(_config, Unset):
            config = UNSET
        else:
            config = SchemaAssertConfigConnectedToCloudData.from_dict(_config)
        ...
        schema_assert_device_connected_to_cloud = cls(
        ...
        schema_assert_device_connected_to_cloud.additional_properties = d
        return schema_assert_device_connected_to_cloud
