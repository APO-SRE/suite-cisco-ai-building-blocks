...
T = TypeVar("T", bound="ReaderAssertPortLinkUp")


@_attrs_define
class ReaderAssertPortLinkUp:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reader_assert_port_link_up = cls(
        ...
        reader_assert_port_link_up.additional_properties = d
        return reader_assert_port_link_up
