...
if TYPE_CHECKING:
    from ..models.schema_assert_config_link_up_data import SchemaAssertConfigLinkUpData
    from ..models.schema_path_path_id import SchemaPathPathId


T = TypeVar("T", bound="SchemaAssertPortLinkUp")


@_attrs_define
class SchemaAssertPortLinkUp:
    ...
    Attributes:
        ...
        category (Union[Unset, ModelsAssertCategoryType]): AssertCategoryType specifies the various kinds of assertion
            categories.
        config (Union[Unset, SchemaAssertConfigLinkUpData]): Description not available
    ...
    config: Union[Unset, "SchemaAssertConfigLinkUpData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config: Union[Unset, SchemaAssertConfigLinkUpData]
        if isinstance(_config, Unset):
            config = UNSET
        else:
            config = SchemaAssertConfigLinkUpData.from_dict(_config)
        ...
        schema_assert_port_link_up = cls(
        ...
        schema_assert_port_link_up.additional_properties = d
        return schema_assert_port_link_up
