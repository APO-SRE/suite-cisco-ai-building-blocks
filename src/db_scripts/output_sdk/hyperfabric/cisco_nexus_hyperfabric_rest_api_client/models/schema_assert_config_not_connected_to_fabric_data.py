...
T = TypeVar("T", bound="SchemaAssertConfigNotConnectedToFabricData")


@_attrs_define
class SchemaAssertConfigNotConnectedToFabricData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        schema_assert_config_not_connected_to_fabric_data = cls(
            fabric_id=fabric_id,
        ...
        schema_assert_config_not_connected_to_fabric_data.additional_properties = d
        return schema_assert_config_not_connected_to_fabric_data
