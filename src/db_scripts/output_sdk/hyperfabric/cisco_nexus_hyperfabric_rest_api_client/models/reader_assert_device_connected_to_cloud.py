...
T = TypeVar("T", bound="ReaderAssertDeviceConnectedToCloud")


@_attrs_define
class ReaderAssertDeviceConnectedToCloud:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reader_assert_device_connected_to_cloud = cls(
        ...
        reader_assert_device_connected_to_cloud.additional_properties = d
        return reader_assert_device_connected_to_cloud
