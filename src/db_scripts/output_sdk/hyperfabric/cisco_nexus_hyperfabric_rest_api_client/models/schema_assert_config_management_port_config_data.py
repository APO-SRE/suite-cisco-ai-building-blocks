...
T = TypeVar("T", bound="SchemaAssertConfigManagementPortConfigData")


@_attrs_define
class SchemaAssertConfigManagementPortConfigData:
    ...
    Attributes:
        ...
        mgmt_port_state (Union[Unset, SchemaManagementState]): Description not available
    ...
    mgmt_port_state: Union[Unset, "SchemaManagementState"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        mgmt_port_state: Union[Unset, dict[str, Any]] = UNSET
        if not isinstance(self.mgmt_port_state, Unset):
            mgmt_port_state = self.mgmt_port_state.to_dict()
        ...
        if mgmt_port_state is not UNSET:
            field_dict["mgmtPortState"] = mgmt_port_state
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _mgmt_port_state = d.pop("mgmtPortState", UNSET)
        mgmt_port_state: Union[Unset, SchemaManagementState]
        if isinstance(_mgmt_port_state, Unset):
            mgmt_port_state = UNSET
        else:
            mgmt_port_state = SchemaManagementState.from_dict(_mgmt_port_state)

        org_id = d.pop("orgId", UNSET)

        schema_assert_config_management_port_config_data = cls(
            fabric_id=fabric_id,
            generation_id=generation_id,
            implicit=implicit,
            latch_time=latch_time,
            latched_at=latched_at,
            mgmt_port_state=mgmt_port_state,
            org_id=org_id,
        )

        schema_assert_config_management_port_config_data.additional_properties = d
        return schema_assert_config_management_port_config_data
