...
T = TypeVar("T", bound="ReaderAssertDeviceConnectedToFabric")


@_attrs_define
class ReaderAssertDeviceConnectedToFabric:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reader_assert_device_connected_to_fabric = cls(
        ...
        reader_assert_device_connected_to_fabric.additional_properties = d
        return reader_assert_device_connected_to_fabric
