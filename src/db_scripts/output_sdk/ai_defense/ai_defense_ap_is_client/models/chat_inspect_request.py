...
T = TypeVar("T", bound="ChatInspectRequest")


@_attrs_define
class ChatInspectRequest:
    """The request to inspect a chat conversation
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        chat_inspect_request = cls(
            messages=messages,
            metadata=metadata,
            config=config,
        )

        chat_inspect_request.additional_properties = d
        return chat_inspect_request
