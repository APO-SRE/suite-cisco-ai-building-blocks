...
from ...models.chat_inspect_request import ChatInspectRequest
...
def sync_detailed(
    *,
    ...
    """Inspect conversations
     ...
     The Chat Inspection API is designed to inspect the AI chat conversations covering prompts and
    responses for security, safety, and privacy concerns.

    Args:
        x_cisco_ai_defense_api_key (str):
        body (ChatInspectRequest): The request to inspect a chat conversation
