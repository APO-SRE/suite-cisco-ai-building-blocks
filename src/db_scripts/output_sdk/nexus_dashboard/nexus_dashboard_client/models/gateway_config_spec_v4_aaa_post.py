...
T = TypeVar("T", bound="GatewayConfigSpecV4AaaPOST")


@_attrs_define
class GatewayConfigSpecV4AaaPOST:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gateway_config_spec_v4_aaa_post = cls(
        ...
        gateway_config_spec_v4_aaa_post.additional_properties = d
        return gateway_config_spec_v4_aaa_post
