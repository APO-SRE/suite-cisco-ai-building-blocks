...
T = TypeVar("T", bound="SiteFederationInfoV4SitemanagementPOST")


@_attrs_define
class SiteFederationInfoV4SitemanagementPOST:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_federation_info_v4_sitemanagement_post = cls(
        ...
        site_federation_info_v4_sitemanagement_post.additional_properties = d
        return site_federation_info_v4_sitemanagement_post
