...
if TYPE_CHECKING:
    ...
    from ..models.site_spec_v4_sitemanagement_get_annotation import SiteSpecV4SitemanagementGETAnnotation


T = TypeVar("T", bound="SiteSpecV4SitemanagementGET")


@_attrs_define
class SiteSpecV4SitemanagementGET:
    """
    Attributes:
        annotation (Union[Unset, SiteSpecV4SitemanagementGETAnnotation]): annotation for the site
    ...
    annotation: Union[Unset, "SiteSpecV4SitemanagementGETAnnotation"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        annotation: Union[Unset, SiteSpecV4SitemanagementGETAnnotation]
        if isinstance(_annotation, Unset):
            annotation = UNSET
        else:
            annotation = SiteSpecV4SitemanagementGETAnnotation.from_dict(_annotation)
        ...
        site_spec_v4_sitemanagement_get = cls(
        ...
        site_spec_v4_sitemanagement_get.additional_properties = d
        return site_spec_v4_sitemanagement_get
