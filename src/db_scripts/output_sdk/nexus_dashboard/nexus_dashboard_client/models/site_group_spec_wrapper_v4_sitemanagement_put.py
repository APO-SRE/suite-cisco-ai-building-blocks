...
T = TypeVar("T", bound="SiteGroupSpecWrapperV4SitemanagementPUT")


@_attrs_define
class SiteGroupSpecWrapperV4SitemanagementPUT:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_group_spec_wrapper_v4_sitemanagement_put = cls(
        ...
        site_group_spec_wrapper_v4_sitemanagement_put.additional_properties = d
        return site_group_spec_wrapper_v4_sitemanagement_put
