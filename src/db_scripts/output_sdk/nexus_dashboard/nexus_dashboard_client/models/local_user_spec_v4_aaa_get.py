...
T = TypeVar("T", bound="LocalUserSpecV4AaaGET")


@_attrs_define
class LocalUserSpecV4AaaGET:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        local_user_spec_v4_aaa_get = cls(
            email=email,
        ...
        local_user_spec_v4_aaa_get.additional_properties = d
        return local_user_spec_v4_aaa_get
