...
T = TypeVar("T", bound="TriggerGroupV1EventmonitoringGET")


@_attrs_define
class TriggerGroupV1EventmonitoringGET:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        trigger_group_v1_eventmonitoring_get = cls(
        ...
        trigger_group_v1_eventmonitoring_get.additional_properties = d
        return trigger_group_v1_eventmonitoring_get
