...
T = TypeVar("T", bound="NodeSpecNetworkV1PlatformPOST")


@_attrs_define
class NodeSpecNetworkV1PlatformPOST:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        node_spec_network_v1_platform_post = cls(
            gateway=gateway,
            gatewayv6=gatewayv6,
            subnet=subnet,
            subnetv6=subnetv6,
        ...
        node_spec_network_v1_platform_post.additional_properties = d
        return node_spec_network_v1_platform_post
