...
from ..models.cluster_spec_v2_platform_put_network_mode import ClusterSpecV2PlatformPUTNetworkMode
...
T = TypeVar("T", bound="ClusterSpecV2PlatformPUT")


@_attrs_define
class ClusterSpecV2PlatformPUT:
    ...
    Attributes:
        ...
        network_mode (Union[Unset, ClusterSpecV2PlatformPUTNetworkMode]): Shows what IP protocols are configured on this
            cluster
    ...
    network_mode: Union[Unset, ClusterSpecV2PlatformPUTNetworkMode] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        network_mode: Union[Unset, ClusterSpecV2PlatformPUTNetworkMode]
        if isinstance(_network_mode, Unset):
            network_mode = UNSET
        else:
            network_mode = ClusterSpecV2PlatformPUTNetworkMode(_network_mode)
        ...
        cluster_spec_v2_platform_put = cls(
        ...
        cluster_spec_v2_platform_put.additional_properties = d
        return cluster_spec_v2_platform_put
