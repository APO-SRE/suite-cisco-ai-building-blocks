...
T = TypeVar("T", bound="GatewayConfigSpecV4AaaGET")


@_attrs_define
class GatewayConfigSpecV4AaaGET:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gateway_config_spec_v4_aaa_get = cls(
        ...
        gateway_config_spec_v4_aaa_get.additional_properties = d
        return gateway_config_spec_v4_aaa_get
