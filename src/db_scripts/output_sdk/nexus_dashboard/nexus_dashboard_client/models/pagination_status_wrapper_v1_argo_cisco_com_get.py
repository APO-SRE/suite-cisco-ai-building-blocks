...
if TYPE_CHECKING:
    from ..models.paginated_object_descriptor_v1_argo_cisco_com_get import PaginatedObjectDescriptorV1ArgoCiscoComGET
    from ..models.pagination_status_wrapper_v1_argo_cisco_com_get_intra_type_i_ds import (
        PaginationStatusWrapperV1ArgoCiscoComGETIntraTypeIDs,
    )


T = TypeVar("T", bound="PaginationStatusWrapperV1ArgoCiscoComGET")


@_attrs_define
class PaginationStatusWrapperV1ArgoCiscoComGET:
    """
    Attributes:
        fields_resolve_meta_ptrs (Union[Unset, list[str]]):
        inc (Union[Unset, bool]):
        intra_type_i_ds (Union[Unset, PaginationStatusWrapperV1ArgoCiscoComGETIntraTypeIDs]):
        match_expression (Union[Unset, str]):
        order_by (Union[Unset, list[str]]):
        results (Union[Unset, list['PaginatedObjectDescriptorV1ArgoCiscoComGET']]):
        updated (Union[Unset, str]):
    """

    fields_resolve_meta_ptrs: Union[Unset, list[str]] = UNSET
    inc: Union[Unset, bool] = UNSET
    intra_type_i_ds: Union[Unset, "PaginationStatusWrapperV1ArgoCiscoComGETIntraTypeIDs"] = UNSET
    match_expression: Union[Unset, str] = UNSET
    order_by: Union[Unset, list[str]] = UNSET
    results: Union[Unset, list["PaginatedObjectDescriptorV1ArgoCiscoComGET"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.paginated_object_descriptor_v1_argo_cisco_com_get import (
        ...
        if isinstance(_intra_type_i_ds, Unset):
            ...
            intra_type_i_ds = PaginationStatusWrapperV1ArgoCiscoComGETIntraTypeIDs.from_dict(_intra_type_i_ds)
        ...
        for results_item_data in _results or []:
            results_item = PaginatedObjectDescriptorV1ArgoCiscoComGET.from_dict(results_item_data)

            results.append(results_item)

        updated = d.pop("updated", UNSET)

        pagination_status_wrapper_v1_argo_cisco_com_get = cls(
        ...
        pagination_status_wrapper_v1_argo_cisco_com_get.additional_properties = d
        return pagination_status_wrapper_v1_argo_cisco_com_get
