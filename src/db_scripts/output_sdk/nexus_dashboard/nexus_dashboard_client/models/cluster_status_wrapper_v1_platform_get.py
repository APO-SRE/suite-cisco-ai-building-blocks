...
from ..models.cluster_status_wrapper_v1_platform_get_state import ClusterStatusWrapperV1PlatformGETState
...
T = TypeVar("T", bound="ClusterStatusWrapperV1PlatformGET")


@_attrs_define
class ClusterStatusWrapperV1PlatformGET:
    """
    Attributes:
        ...
        state (Union[Unset, ClusterStatusWrapperV1PlatformGETState]): State of dual-stack mode in cluster
    ...
    state: Union[Unset, ClusterStatusWrapperV1PlatformGETState] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        state: Union[Unset, ClusterStatusWrapperV1PlatformGETState]
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = ClusterStatusWrapperV1PlatformGETState(_state)

        target_version = d.pop("targetVersion", UNSET)

        uuid = d.pop("uuid", UNSET)

        cluster_status_wrapper_v1_platform_get = cls(
        ...
        cluster_status_wrapper_v1_platform_get.additional_properties = d
        return cluster_status_wrapper_v1_platform_get
