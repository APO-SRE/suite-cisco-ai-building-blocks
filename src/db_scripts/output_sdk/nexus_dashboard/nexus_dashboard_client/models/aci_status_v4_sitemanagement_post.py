...
T = TypeVar("T", bound="ACIStatusV4SitemanagementPOST")


@_attrs_define
class ACIStatusV4SitemanagementPOST:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        aci_status_v4_sitemanagement_post = cls(
            app_user_name=app_user_name,
        )

        aci_status_v4_sitemanagement_post.additional_properties = d
        return aci_status_v4_sitemanagement_post
