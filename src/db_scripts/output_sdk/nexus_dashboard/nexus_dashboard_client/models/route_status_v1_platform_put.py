...
T = TypeVar("T", bound="RouteStatusV1PlatformPUT")


@_attrs_define
class RouteStatusV1PlatformPUT:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        route_status_v1_platform_put = cls(
            error=error,
        )

        route_status_v1_platform_put.additional_properties = d
        return route_status_v1_platform_put
