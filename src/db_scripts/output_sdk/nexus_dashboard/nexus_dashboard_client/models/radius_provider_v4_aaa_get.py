...
from ..models.radius_provider_v4_aaa_get_auth_protocol import RADIUSProviderV4AaaGETAuthProtocol
from ..types import UNSET, Unset

T = TypeVar("T", bound="RADIUSProviderV4AaaGET")


@_attrs_define
class RADIUSProviderV4AaaGET:
    """
    Attributes:
        auth_protocol (Union[Unset, RADIUSProviderV4AaaGETAuthProtocol]): RADIUS provider server authentication
            mechanism
    ...
    auth_protocol: Union[Unset, RADIUSProviderV4AaaGETAuthProtocol] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        auth_protocol: Union[Unset, RADIUSProviderV4AaaGETAuthProtocol]
        if isinstance(_auth_protocol, Unset):
            auth_protocol = UNSET
        else:
            auth_protocol = RADIUSProviderV4AaaGETAuthProtocol(_auth_protocol)
        ...
        radius_provider_v4_aaa_get = cls(
        ...
        radius_provider_v4_aaa_get.additional_properties = d
        return radius_provider_v4_aaa_get
