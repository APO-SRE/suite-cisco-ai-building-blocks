...
T = TypeVar("T", bound="RetentionPolicyV1EventmonitoringPUT")


@_attrs_define
class RetentionPolicyV1EventmonitoringPUT:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        retention_policy_v1_eventmonitoring_put = cls(
            count=count,
            duration=duration,
            size=size,
        )

        retention_policy_v1_eventmonitoring_put.additional_properties = d
        return retention_policy_v1_eventmonitoring_put
