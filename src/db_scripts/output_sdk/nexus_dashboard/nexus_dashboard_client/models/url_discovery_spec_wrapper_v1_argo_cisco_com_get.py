...
T = TypeVar("T", bound="URLDiscoverySpecWrapperV1ArgoCiscoComGET")


@_attrs_define
class URLDiscoverySpecWrapperV1ArgoCiscoComGET:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        url_discovery_spec_wrapper_v1_argo_cisco_com_get = cls(
            name=name,
            realm=realm,
            resources=resources,
            services=services,
        ...
        url_discovery_spec_wrapper_v1_argo_cisco_com_get.additional_properties = d
        return url_discovery_spec_wrapper_v1_argo_cisco_com_get
