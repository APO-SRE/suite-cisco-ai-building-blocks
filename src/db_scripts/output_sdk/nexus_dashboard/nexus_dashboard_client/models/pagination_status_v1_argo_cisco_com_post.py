...
if TYPE_CHECKING:
    ...
    from ..models.pagination_status_v1_argo_cisco_com_post_intra_type_i_ds import (
        PaginationStatusV1ArgoCiscoComPOSTIntraTypeIDs,
    )


T = TypeVar("T", bound="PaginationStatusV1ArgoCiscoComPOST")


@_attrs_define
class PaginationStatusV1ArgoCiscoComPOST:
    """
    Attributes:
        fields_resolve_meta_ptrs (Union[Unset, list[str]]):
        inc (Union[Unset, bool]):
        intra_type_i_ds (Union[Unset, PaginationStatusV1ArgoCiscoComPOSTIntraTypeIDs]):
    ...
    intra_type_i_ds: Union[Unset, "PaginationStatusV1ArgoCiscoComPOSTIntraTypeIDs"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_intra_type_i_ds, Unset):
            ...
            intra_type_i_ds = PaginationStatusV1ArgoCiscoComPOSTIntraTypeIDs.from_dict(_intra_type_i_ds)
        ...
        pagination_status_v1_argo_cisco_com_post = cls(
        ...
        pagination_status_v1_argo_cisco_com_post.additional_properties = d
        return pagination_status_v1_argo_cisco_com_post
