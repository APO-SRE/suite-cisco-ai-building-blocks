...
if TYPE_CHECKING:
    from ..models.user_preference_spec_v4_aaa_post_custom_preferences import (
        UserPreferenceSpecV4AaaPOSTCustomPreferences,
    )
    from ..models.user_preference_spec_v4_aaa_post_displayed_app_instances import (
        UserPreferenceSpecV4AaaPOSTDisplayedAppInstances,
    )


T = TypeVar("T", bound="UserPreferenceSpecV4AaaPOST")


@_attrs_define
class UserPreferenceSpecV4AaaPOST:
    """
    Attributes:
        custom_preferences (Union[Unset, UserPreferenceSpecV4AaaPOSTCustomPreferences]): Custom user preferences fields
        displayed_app_instances (Union[Unset, UserPreferenceSpecV4AaaPOSTDisplayedAppInstances]): Application instances
    ...
    custom_preferences: Union[Unset, "UserPreferenceSpecV4AaaPOSTCustomPreferences"] = UNSET
    displayed_app_instances: Union[Unset, "UserPreferenceSpecV4AaaPOSTDisplayedAppInstances"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_preferences: Union[Unset, UserPreferenceSpecV4AaaPOSTCustomPreferences]
        if isinstance(_custom_preferences, Unset):
            custom_preferences = UNSET
        else:
            custom_preferences = UserPreferenceSpecV4AaaPOSTCustomPreferences.from_dict(_custom_preferences)

        _displayed_app_instances = d.pop("displayedAppInstances", UNSET)
        displayed_app_instances: Union[Unset, UserPreferenceSpecV4AaaPOSTDisplayedAppInstances]
        if isinstance(_displayed_app_instances, Unset):
            displayed_app_instances = UNSET
        else:
            displayed_app_instances = UserPreferenceSpecV4AaaPOSTDisplayedAppInstances.from_dict(
        ...
        user_preference_spec_v4_aaa_post = cls(
        ...
        user_preference_spec_v4_aaa_post.additional_properties = d
        return user_preference_spec_v4_aaa_post
