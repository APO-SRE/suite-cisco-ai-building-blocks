...
T = TypeVar("T", bound="ApplicationSpecV1ArgoCiscoComGET")


@_attrs_define
class ApplicationSpecV1ArgoCiscoComGET:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        application_spec_v1_argo_cisco_com_get = cls(
            name=name,
            realm=realm,
            resources=resources,
            services=services,
        ...
        application_spec_v1_argo_cisco_com_get.additional_properties = d
        return application_spec_v1_argo_cisco_com_get
