...
T = TypeVar("T", bound="PasswordPolicyV4AaaPUT")


@_attrs_define
class PasswordPolicyV4AaaPUT:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        password_policy_v4_aaa_put = cls(
            reuse_limitation=reuse_limitation,
            time_interval_limitation=time_interval_limitation,
        )

        password_policy_v4_aaa_put.additional_properties = d
        return password_policy_v4_aaa_put
