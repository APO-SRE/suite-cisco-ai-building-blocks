...
T = TypeVar("T", bound="NDFCConfigV4SitemanagementGET")


@_attrs_define
class NDFCConfigV4SitemanagementGET:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ndfc_config_v4_sitemanagement_get = cls(
        ...
        ndfc_config_v4_sitemanagement_get.additional_properties = d
        return ndfc_config_v4_sitemanagement_get
