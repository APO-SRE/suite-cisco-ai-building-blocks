...
T = TypeVar("T", bound="UserPreferenceSpecV4AaaPUTDisplayedAppInstances")


@_attrs_define
class UserPreferenceSpecV4AaaPUTDisplayedAppInstances:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        user_preference_spec_v4_aaa_put_displayed_app_instances = cls()
        ...
        user_preference_spec_v4_aaa_put_displayed_app_instances.additional_properties = additional_properties
        return user_preference_spec_v4_aaa_put_displayed_app_instances
