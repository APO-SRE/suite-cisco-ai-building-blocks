...
T = TypeVar("T", bound="EventConfigSpecWrapperV1EventmonitoringGET")


@_attrs_define
class EventConfigSpecWrapperV1EventmonitoringGET:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        event_config_spec_wrapper_v1_eventmonitoring_get = cls(
        ...
        event_config_spec_wrapper_v1_eventmonitoring_get.additional_properties = d
        return event_config_spec_wrapper_v1_eventmonitoring_get
