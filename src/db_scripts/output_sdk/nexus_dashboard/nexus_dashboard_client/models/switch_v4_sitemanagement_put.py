...
T = TypeVar("T", bound="SwitchV4SitemanagementPUT")


@_attrs_define
class SwitchV4SitemanagementPUT:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        switch_v4_sitemanagement_put = cls(
            inband_ip=inband_ip,
            model=model,
        ...
        switch_v4_sitemanagement_put.additional_properties = d
        return switch_v4_sitemanagement_put
