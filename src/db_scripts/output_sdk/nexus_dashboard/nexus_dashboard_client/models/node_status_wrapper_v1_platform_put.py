...
from ..models.node_status_wrapper_v1_platform_put_machine_type import NodeStatusWrapperV1PlatformPUTMachineType
from ..models.node_status_wrapper_v1_platform_put_platform_type import NodeStatusWrapperV1PlatformPUTPlatformType
from ..models.node_status_wrapper_v1_platform_put_state import NodeStatusWrapperV1PlatformPUTState
...
T = TypeVar("T", bound="NodeStatusWrapperV1PlatformPUT")


@_attrs_define
class NodeStatusWrapperV1PlatformPUT:
    """
    Attributes:
        ...
        machine_type (Union[Unset, NodeStatusWrapperV1PlatformPUTMachineType]): Node hardware type
        model (Union[Unset, str]): Node model
        platform_type (Union[Unset, NodeStatusWrapperV1PlatformPUTPlatformType]): Node platform type
        serf_status (Union[Unset, str]): Node's Serf status
        state (Union[Unset, NodeStatusWrapperV1PlatformPUTState]): Node operational Status
    ...
    machine_type: Union[Unset, NodeStatusWrapperV1PlatformPUTMachineType] = UNSET
    model: Union[Unset, str] = UNSET
    platform_type: Union[Unset, NodeStatusWrapperV1PlatformPUTPlatformType] = UNSET
    serf_status: Union[Unset, str] = UNSET
    state: Union[Unset, NodeStatusWrapperV1PlatformPUTState] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        machine_type: Union[Unset, NodeStatusWrapperV1PlatformPUTMachineType]
        if isinstance(_machine_type, Unset):
            machine_type = UNSET
        else:
            machine_type = NodeStatusWrapperV1PlatformPUTMachineType(_machine_type)

        model = d.pop("model", UNSET)

        _platform_type = d.pop("platformType", UNSET)
        platform_type: Union[Unset, NodeStatusWrapperV1PlatformPUTPlatformType]
        if isinstance(_platform_type, Unset):
            platform_type = UNSET
        else:
            platform_type = NodeStatusWrapperV1PlatformPUTPlatformType(_platform_type)

        serf_status = d.pop("serfStatus", UNSET)

        _state = d.pop("state", UNSET)
        state: Union[Unset, NodeStatusWrapperV1PlatformPUTState]
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = NodeStatusWrapperV1PlatformPUTState(_state)

        uuid = d.pop("uuid", UNSET)

        version = d.pop("version", UNSET)

        node_status_wrapper_v1_platform_put = cls(
            boot_time=boot_time,
        ...
        node_status_wrapper_v1_platform_put.additional_properties = d
        return node_status_wrapper_v1_platform_put
