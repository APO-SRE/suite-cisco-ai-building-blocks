...
if TYPE_CHECKING:
    from ..models.user_preference_spec_wrapper_v4_aaa_get_custom_preferences import (
        UserPreferenceSpecWrapperV4AaaGETCustomPreferences,
    )
    from ..models.user_preference_spec_wrapper_v4_aaa_get_displayed_app_instances import (
        UserPreferenceSpecWrapperV4AaaGETDisplayedAppInstances,
    )


T = TypeVar("T", bound="UserPreferenceSpecWrapperV4AaaGET")


@_attrs_define
class UserPreferenceSpecWrapperV4AaaGET:
    """
    Attributes:
        custom_preferences (Union[Unset, UserPreferenceSpecWrapperV4AaaGETCustomPreferences]): Custom user preferences
            fields
        displayed_app_instances (Union[Unset, UserPreferenceSpecWrapperV4AaaGETDisplayedAppInstances]): Application
    ...
    custom_preferences: Union[Unset, "UserPreferenceSpecWrapperV4AaaGETCustomPreferences"] = UNSET
    displayed_app_instances: Union[Unset, "UserPreferenceSpecWrapperV4AaaGETDisplayedAppInstances"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_preferences: Union[Unset, UserPreferenceSpecWrapperV4AaaGETCustomPreferences]
        if isinstance(_custom_preferences, Unset):
            custom_preferences = UNSET
        else:
            custom_preferences = UserPreferenceSpecWrapperV4AaaGETCustomPreferences.from_dict(_custom_preferences)

        _displayed_app_instances = d.pop("displayedAppInstances", UNSET)
        displayed_app_instances: Union[Unset, UserPreferenceSpecWrapperV4AaaGETDisplayedAppInstances]
        if isinstance(_displayed_app_instances, Unset):
            displayed_app_instances = UNSET
        else:
            displayed_app_instances = UserPreferenceSpecWrapperV4AaaGETDisplayedAppInstances.from_dict(
        ...
        user_preference_spec_wrapper_v4_aaa_get = cls(
        ...
        user_preference_spec_wrapper_v4_aaa_get.additional_properties = d
        return user_preference_spec_wrapper_v4_aaa_get
