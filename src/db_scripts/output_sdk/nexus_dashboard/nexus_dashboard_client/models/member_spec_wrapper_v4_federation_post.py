...
T = TypeVar("T", bound="MemberSpecWrapperV4FederationPOST")


@_attrs_define
class MemberSpecWrapperV4FederationPOST:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        member_spec_wrapper_v4_federation_post = cls(
            host=host,
        ...
        member_spec_wrapper_v4_federation_post.additional_properties = d
        return member_spec_wrapper_v4_federation_post
