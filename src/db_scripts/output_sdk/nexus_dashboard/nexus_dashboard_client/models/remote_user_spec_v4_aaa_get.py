...
T = TypeVar("T", bound="RemoteUserSpecV4AaaGET")


@_attrs_define
class RemoteUserSpecV4AaaGET:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        remote_user_spec_v4_aaa_get = cls(
        ...
        remote_user_spec_v4_aaa_get.additional_properties = d
        return remote_user_spec_v4_aaa_get
