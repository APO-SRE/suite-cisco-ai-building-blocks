...
from ..models.ldap_provider_v4_aaa_put_ssl_strictness_level import LDAPProviderV4AaaPUTSslStrictnessLevel
from ..types import UNSET, Unset

T = TypeVar("T", bound="LDAPProviderV4AaaPUT")


@_attrs_define
class LDAPProviderV4AaaPUT:
    """
    Attributes:
        ...
        ssl_strictness_level (Union[Unset, LDAPProviderV4AaaPUTSslStrictnessLevel]): SSL Strictness Level
    ...
    ssl_strictness_level: Union[Unset, LDAPProviderV4AaaPUTSslStrictnessLevel] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ssl_strictness_level: Union[Unset, LDAPProviderV4AaaPUTSslStrictnessLevel]
        if isinstance(_ssl_strictness_level, Unset):
            ssl_strictness_level = UNSET
        else:
            ssl_strictness_level = LDAPProviderV4AaaPUTSslStrictnessLevel(_ssl_strictness_level)

        timeout = d.pop("timeout", UNSET)

        ldap_provider_v4_aaa_put = cls(
            attribute=attribute,
            base_dn=base_dn,
            bind_dn=bind_dn,
        ...
        ldap_provider_v4_aaa_put.additional_properties = d
        return ldap_provider_v4_aaa_put
