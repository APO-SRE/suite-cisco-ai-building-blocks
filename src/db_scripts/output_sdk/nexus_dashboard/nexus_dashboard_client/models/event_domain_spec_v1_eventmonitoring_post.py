...
T = TypeVar("T", bound="EventDomainSpecV1EventmonitoringPOST")


@_attrs_define
class EventDomainSpecV1EventmonitoringPOST:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        event_domain_spec_v1_eventmonitoring_post = cls(
            event_configs=event_configs,
            meta_name=meta_name,
        )

        event_domain_spec_v1_eventmonitoring_post.additional_properties = d
        return event_domain_spec_v1_eventmonitoring_post
