...
from ..models.member_status_wrapper_v4_federation_put_reachability import MemberStatusWrapperV4FederationPUTReachability
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.cluster_node_v4_federation_put import ClusterNodeV4FederationPUT


T = TypeVar("T", bound="MemberStatusWrapperV4FederationPUT")


@_attrs_define
class MemberStatusWrapperV4FederationPUT:
    """
    Attributes:
        cluster_info (Union[Unset, list['ClusterNodeV4FederationPUT']]):
        ...
        reachability (Union[Unset, MemberStatusWrapperV4FederationPUTReachability]): Member reachability status -
            Unknown/Up/Down
    """

    cluster_info: Union[Unset, list["ClusterNodeV4FederationPUT"]] = UNSET
    federation_id: Union[Unset, str] = UNSET
    manager: Union[Unset, bool] = UNSET
    member_id: Union[Unset, str] = UNSET
    name: Union[Unset, str] = UNSET
    reachability: Union[Unset, MemberStatusWrapperV4FederationPUTReachability] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for cluster_info_item_data in _cluster_info or []:
            cluster_info_item = ClusterNodeV4FederationPUT.from_dict(cluster_info_item_data)
        ...
        reachability: Union[Unset, MemberStatusWrapperV4FederationPUTReachability]
        if isinstance(_reachability, Unset):
            reachability = UNSET
        else:
            reachability = MemberStatusWrapperV4FederationPUTReachability(_reachability)

        member_status_wrapper_v4_federation_put = cls(
        ...
        member_status_wrapper_v4_federation_put.additional_properties = d
        return member_status_wrapper_v4_federation_put
