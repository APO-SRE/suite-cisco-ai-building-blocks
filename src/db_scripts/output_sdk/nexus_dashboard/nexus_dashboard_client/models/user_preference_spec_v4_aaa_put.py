...
if TYPE_CHECKING:
    from ..models.user_preference_spec_v4_aaa_put_custom_preferences import UserPreferenceSpecV4AaaPUTCustomPreferences
    from ..models.user_preference_spec_v4_aaa_put_displayed_app_instances import (
        UserPreferenceSpecV4AaaPUTDisplayedAppInstances,
    )


T = TypeVar("T", bound="UserPreferenceSpecV4AaaPUT")


@_attrs_define
class UserPreferenceSpecV4AaaPUT:
    """
    Attributes:
        custom_preferences (Union[Unset, UserPreferenceSpecV4AaaPUTCustomPreferences]): Custom user preferences fields
        displayed_app_instances (Union[Unset, UserPreferenceSpecV4AaaPUTDisplayedAppInstances]): Application instances
            for which What's New already displayed
    ...
    custom_preferences: Union[Unset, "UserPreferenceSpecV4AaaPUTCustomPreferences"] = UNSET
    displayed_app_instances: Union[Unset, "UserPreferenceSpecV4AaaPUTDisplayedAppInstances"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.user_preference_spec_v4_aaa_put_custom_preferences import (
        ...
        custom_preferences: Union[Unset, UserPreferenceSpecV4AaaPUTCustomPreferences]
        if isinstance(_custom_preferences, Unset):
            custom_preferences = UNSET
        else:
            custom_preferences = UserPreferenceSpecV4AaaPUTCustomPreferences.from_dict(_custom_preferences)

        _displayed_app_instances = d.pop("displayedAppInstances", UNSET)
        displayed_app_instances: Union[Unset, UserPreferenceSpecV4AaaPUTDisplayedAppInstances]
        if isinstance(_displayed_app_instances, Unset):
            displayed_app_instances = UNSET
        else:
            displayed_app_instances = UserPreferenceSpecV4AaaPUTDisplayedAppInstances.from_dict(
        ...
        user_preference_spec_v4_aaa_put = cls(
        ...
        user_preference_spec_v4_aaa_put.additional_properties = d
        return user_preference_spec_v4_aaa_put
