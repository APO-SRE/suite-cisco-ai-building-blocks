...
T = TypeVar("T", bound="CertificateMetadataV4AaaPOST")


@_attrs_define
class CertificateMetadataV4AaaPOST:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        certificate_metadata_v4_aaa_post = cls(
        ...
        certificate_metadata_v4_aaa_post.additional_properties = d
        return certificate_metadata_v4_aaa_post
