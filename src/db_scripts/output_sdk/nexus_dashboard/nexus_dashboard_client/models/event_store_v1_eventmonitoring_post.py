...
T = TypeVar("T", bound="EventStoreV1EventmonitoringPOST")


@_attrs_define
class EventStoreV1EventmonitoringPOST:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        event_store_v1_eventmonitoring_post = cls(
            current_event_occurrences=current_event_occurrences,
            total_event_count=total_event_count,
        )

        event_store_v1_eventmonitoring_post.additional_properties = d
        return event_store_v1_eventmonitoring_post
