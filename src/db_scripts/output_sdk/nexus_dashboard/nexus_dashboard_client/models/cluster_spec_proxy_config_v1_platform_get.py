...
if TYPE_CHECKING:
    from ..models.cluster_spec_proxy_server_v1_platform_get import ClusterSpecProxyServerV1PlatformGET


T = TypeVar("T", bound="ClusterSpecProxyConfigV1PlatformGET")


@_attrs_define
class ClusterSpecProxyConfigV1PlatformGET:
    ...
    Attributes:
        ...
        servers (Union[Unset, list['ClusterSpecProxyServerV1PlatformGET']]): Proxy server list
        username (Union[Unset, str]): Cluster proxy username
    """

    ignore_hosts: Union[Unset, list[str]] = UNSET
    password: Union[Unset, str] = UNSET
    servers: Union[Unset, list["ClusterSpecProxyServerV1PlatformGET"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for servers_item_data in _servers or []:
            servers_item = ClusterSpecProxyServerV1PlatformGET.from_dict(servers_item_data)

            servers.append(servers_item)

        username = d.pop("username", UNSET)

        cluster_spec_proxy_config_v1_platform_get = cls(
        ...
        cluster_spec_proxy_config_v1_platform_get.additional_properties = d
        return cluster_spec_proxy_config_v1_platform_get
