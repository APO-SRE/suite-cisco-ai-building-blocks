...
T = TypeVar("T", bound="TrustedJWTKeysSpecV4AaaPOST")


@_attrs_define
class TrustedJWTKeysSpecV4AaaPOST:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        trusted_jwt_keys_spec_v4_aaa_post = cls(
            app_name=app_name,
            key_id=key_id,
        ...
        trusted_jwt_keys_spec_v4_aaa_post.additional_properties = d
        return trusted_jwt_keys_spec_v4_aaa_post
