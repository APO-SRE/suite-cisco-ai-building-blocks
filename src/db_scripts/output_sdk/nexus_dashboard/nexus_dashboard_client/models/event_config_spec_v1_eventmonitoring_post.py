...
T = TypeVar("T", bound="EventConfigSpecV1EventmonitoringPOST")


@_attrs_define
class EventConfigSpecV1EventmonitoringPOST:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        event_config_spec_v1_eventmonitoring_post = cls(
        ...
        event_config_spec_v1_eventmonitoring_post.additional_properties = d
        return event_config_spec_v1_eventmonitoring_post
