...
T = TypeVar("T", bound="SiteGroupStatusV4SitemanagementGET")


@_attrs_define
class SiteGroupStatusV4SitemanagementGET:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_group_status_v4_sitemanagement_get = cls(
            apps=apps,
            members=members,
        )

        site_group_status_v4_sitemanagement_get.additional_properties = d
        return site_group_status_v4_sitemanagement_get
