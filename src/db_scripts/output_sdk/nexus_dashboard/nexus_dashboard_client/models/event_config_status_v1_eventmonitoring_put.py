...
T = TypeVar("T", bound="EventConfigStatusV1EventmonitoringPUT")


@_attrs_define
class EventConfigStatusV1EventmonitoringPUT:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        event_config_status_v1_eventmonitoring_put = cls(
            error=error,
            event_store=event_store,
        )

        event_config_status_v1_eventmonitoring_put.additional_properties = d
        return event_config_status_v1_eventmonitoring_put
