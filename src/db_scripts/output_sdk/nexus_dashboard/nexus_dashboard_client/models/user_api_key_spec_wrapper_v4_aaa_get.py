...
T = TypeVar("T", bound="UserAPIKeySpecWrapperV4AaaGET")


@_attrs_define
class UserAPIKeySpecWrapperV4AaaGET:
    """
    Attributes:
        ...
        user_name (Union[Unset, str]): UserName of the associated local user for this API Key
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_api_key_spec_wrapper_v4_aaa_get = cls(
            api_key=api_key,
        ...
        user_api_key_spec_wrapper_v4_aaa_get.additional_properties = d
        return user_api_key_spec_wrapper_v4_aaa_get
