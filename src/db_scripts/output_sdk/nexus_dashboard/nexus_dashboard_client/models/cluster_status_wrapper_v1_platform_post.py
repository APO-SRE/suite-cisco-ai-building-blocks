...
from ..models.cluster_status_wrapper_v1_platform_post_state import ClusterStatusWrapperV1PlatformPOSTState
...
T = TypeVar("T", bound="ClusterStatusWrapperV1PlatformPOST")


@_attrs_define
class ClusterStatusWrapperV1PlatformPOST:
    """
    Attributes:
        ...
        state (Union[Unset, ClusterStatusWrapperV1PlatformPOSTState]): State of dual-stack mode in cluster
    ...
    state: Union[Unset, ClusterStatusWrapperV1PlatformPOSTState] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        state: Union[Unset, ClusterStatusWrapperV1PlatformPOSTState]
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = ClusterStatusWrapperV1PlatformPOSTState(_state)

        target_version = d.pop("targetVersion", UNSET)

        uuid = d.pop("uuid", UNSET)

        cluster_status_wrapper_v1_platform_post = cls(
        ...
        cluster_status_wrapper_v1_platform_post.additional_properties = d
        return cluster_status_wrapper_v1_platform_post
