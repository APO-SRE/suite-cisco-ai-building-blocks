...
from ..models.node_spec_v1_platform_put_role import NodeSpecV1PlatformPUTRole
...
T = TypeVar("T", bound="NodeSpecV1PlatformPUT")


@_attrs_define
class NodeSpecV1PlatformPUT:
    """Node configuration
    ...
    Attributes:
        ...
        role (Union[Unset, NodeSpecV1PlatformPUTRole]): Node role
    ...
    role: Union[Unset, NodeSpecV1PlatformPUTRole] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        role: Union[Unset, NodeSpecV1PlatformPUTRole]
        if isinstance(_role, Unset):
            role = UNSET
        else:
            role = NodeSpecV1PlatformPUTRole(_role)

        serial_number = d.pop("serialNumber", UNSET)

        node_spec_v1_platform_put = cls(
        ...
        node_spec_v1_platform_put.additional_properties = d
        return node_spec_v1_platform_put
