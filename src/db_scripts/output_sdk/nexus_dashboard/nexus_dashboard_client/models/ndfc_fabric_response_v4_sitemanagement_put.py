...
T = TypeVar("T", bound="NDFCFabricResponseV4SitemanagementPUT")


@_attrs_define
class NDFCFabricResponseV4SitemanagementPUT:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ndfc_fabric_response_v4_sitemanagement_put = cls(
            in_use=in_use,
            name=name,
        ...
        ndfc_fabric_response_v4_sitemanagement_put.additional_properties = d
        return ndfc_fabric_response_v4_sitemanagement_put
