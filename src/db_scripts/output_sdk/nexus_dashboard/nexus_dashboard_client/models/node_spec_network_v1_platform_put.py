...
T = TypeVar("T", bound="NodeSpecNetworkV1PlatformPUT")


@_attrs_define
class NodeSpecNetworkV1PlatformPUT:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        node_spec_network_v1_platform_put = cls(
            gateway=gateway,
            gatewayv6=gatewayv6,
            subnet=subnet,
            subnetv6=subnetv6,
        ...
        node_spec_network_v1_platform_put.additional_properties = d
        return node_spec_network_v1_platform_put
