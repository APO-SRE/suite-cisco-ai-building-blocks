...
if TYPE_CHECKING:
    from ..models.node_bgp_peer_v1_platform_get import NodeBGPPeerV1PlatformGET


T = TypeVar("T", bound="NodeSpecBgpConfigV1PlatformGET")


@_attrs_define
class NodeSpecBgpConfigV1PlatformGET:
    """Node BGP config

    Attributes:
        as_ (Union[Unset, int]): Node autonomous system (AS) number
        peers (Union[Unset, list['NodeBGPPeerV1PlatformGET']]): BGP peer list
        router_id (Union[Unset, str]): Unique Router ID
    """

    as_: Union[Unset, int] = UNSET
    peers: Union[Unset, list["NodeBGPPeerV1PlatformGET"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for peers_item_data in _peers or []:
            peers_item = NodeBGPPeerV1PlatformGET.from_dict(peers_item_data)

            peers.append(peers_item)

        router_id = d.pop("routerID", UNSET)

        node_spec_bgp_config_v1_platform_get = cls(
            as_=as_,
            peers=peers,
            router_id=router_id,
        )

        node_spec_bgp_config_v1_platform_get.additional_properties = d
        return node_spec_bgp_config_v1_platform_get
