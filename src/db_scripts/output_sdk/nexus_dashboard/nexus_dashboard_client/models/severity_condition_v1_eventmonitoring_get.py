...
from ..models.severity_condition_v1_eventmonitoring_get_severity import SeverityConditionV1EventmonitoringGETSeverity
from ..types import UNSET, Unset

T = TypeVar("T", bound="SeverityConditionV1EventmonitoringGET")


@_attrs_define
class SeverityConditionV1EventmonitoringGET:
    ...
    Attributes:
        ...
        severity (Union[Unset, SeverityConditionV1EventmonitoringGETSeverity]): Severity of the alert to be raised
    """
    ...
    severity: Union[Unset, SeverityConditionV1EventmonitoringGETSeverity] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        severity: Union[Unset, SeverityConditionV1EventmonitoringGETSeverity]
        if isinstance(_severity, Unset):
            severity = UNSET
        else:
            severity = SeverityConditionV1EventmonitoringGETSeverity(_severity)

        severity_condition_v1_eventmonitoring_get = cls(
        ...
        severity_condition_v1_eventmonitoring_get.additional_properties = d
        return severity_condition_v1_eventmonitoring_get
