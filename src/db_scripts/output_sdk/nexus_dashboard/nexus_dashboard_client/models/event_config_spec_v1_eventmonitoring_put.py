...
T = TypeVar("T", bound="EventConfigSpecV1EventmonitoringPUT")


@_attrs_define
class EventConfigSpecV1EventmonitoringPUT:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        event_config_spec_v1_eventmonitoring_put = cls(
        ...
        event_config_spec_v1_eventmonitoring_put.additional_properties = d
        return event_config_spec_v1_eventmonitoring_put
