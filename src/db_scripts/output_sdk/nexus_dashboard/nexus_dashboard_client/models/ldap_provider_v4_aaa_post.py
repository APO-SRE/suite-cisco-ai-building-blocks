...
from ..models.ldap_provider_v4_aaa_post_ssl_strictness_level import LDAPProviderV4AaaPOSTSslStrictnessLevel
from ..types import UNSET, Unset

T = TypeVar("T", bound="LDAPProviderV4AaaPOST")


@_attrs_define
class LDAPProviderV4AaaPOST:
    """
    Attributes:
        ...
        ssl_strictness_level (Union[Unset, LDAPProviderV4AaaPOSTSslStrictnessLevel]): SSL Strictness Level
    ...
    ssl_strictness_level: Union[Unset, LDAPProviderV4AaaPOSTSslStrictnessLevel] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ssl_strictness_level: Union[Unset, LDAPProviderV4AaaPOSTSslStrictnessLevel]
        if isinstance(_ssl_strictness_level, Unset):
            ssl_strictness_level = UNSET
        else:
            ssl_strictness_level = LDAPProviderV4AaaPOSTSslStrictnessLevel(_ssl_strictness_level)

        timeout = d.pop("timeout", UNSET)

        ldap_provider_v4_aaa_post = cls(
            attribute=attribute,
            base_dn=base_dn,
            bind_dn=bind_dn,
        ...
        ldap_provider_v4_aaa_post.additional_properties = d
        return ldap_provider_v4_aaa_post
