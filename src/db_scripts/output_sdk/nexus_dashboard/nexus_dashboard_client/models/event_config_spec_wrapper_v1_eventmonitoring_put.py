...
if TYPE_CHECKING:
    from ..models.alert_config_v1_eventmonitoring_put import AlertConfigV1EventmonitoringPUT
    from ..models.retention_policy_v1_eventmonitoring_put import RetentionPolicyV1EventmonitoringPUT
    from ..models.trigger_group_v1_eventmonitoring_put import TriggerGroupV1EventmonitoringPUT


T = TypeVar("T", bound="EventConfigSpecWrapperV1EventmonitoringPUT")


@_attrs_define
class EventConfigSpecWrapperV1EventmonitoringPUT:
    """
    Attributes:
        alert_config (Union[Unset, AlertConfigV1EventmonitoringPUT]): Alert configuration being monitored as part of
            event configuration
        ...
        retention_policy (Union[Unset, RetentionPolicyV1EventmonitoringPUT]): Retention policy for the generated event
            records as part of the parent event configuration
        source (Union[Unset, str]): Source of the issue
        trigger_groups (Union[Unset, list['TriggerGroupV1EventmonitoringPUT']]): List of triggers that govern the stream
            types where the alert can be broadcasted
    """

    alert_config: Union[Unset, "AlertConfigV1EventmonitoringPUT"] = UNSET
    ...
    retention_policy: Union[Unset, "RetentionPolicyV1EventmonitoringPUT"] = UNSET
    source: Union[Unset, str] = UNSET
    trigger_groups: Union[Unset, list["TriggerGroupV1EventmonitoringPUT"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        alert_config: Union[Unset, AlertConfigV1EventmonitoringPUT]
        if isinstance(_alert_config, Unset):
            alert_config = UNSET
        else:
            alert_config = AlertConfigV1EventmonitoringPUT.from_dict(_alert_config)
        ...
        retention_policy: Union[Unset, RetentionPolicyV1EventmonitoringPUT]
        if isinstance(_retention_policy, Unset):
            retention_policy = UNSET
        else:
            retention_policy = RetentionPolicyV1EventmonitoringPUT.from_dict(_retention_policy)
        ...
        for trigger_groups_item_data in _trigger_groups or []:
            trigger_groups_item = TriggerGroupV1EventmonitoringPUT.from_dict(trigger_groups_item_data)

            trigger_groups.append(trigger_groups_item)

        event_config_spec_wrapper_v1_eventmonitoring_put = cls(
        ...
        event_config_spec_wrapper_v1_eventmonitoring_put.additional_properties = d
        return event_config_spec_wrapper_v1_eventmonitoring_put
