...
if TYPE_CHECKING:
    ...
    from ..models.external_ip_status_v1_platform_get_external_ip_allocation import (
        ExternalIpStatusV1PlatformGETExternalIpAllocation,
    )


T = TypeVar("T", bound="ExternalIpStatusV1PlatformGET")


@_attrs_define
class ExternalIpStatusV1PlatformGET:
    ...
    Attributes:
        ...
        external_ip_allocation (Union[Unset, ExternalIpStatusV1PlatformGETExternalIpAllocation]): Map of external IPs
            and the service they are allocated to
    """

    error: Union[Unset, "ExternalIpStatusErrorV1PlatformGET"] = UNSET
    external_ip_allocation: Union[Unset, "ExternalIpStatusV1PlatformGETExternalIpAllocation"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        external_ip_allocation: Union[Unset, ExternalIpStatusV1PlatformGETExternalIpAllocation]
        if isinstance(_external_ip_allocation, Unset):
            external_ip_allocation = UNSET
        else:
            external_ip_allocation = ExternalIpStatusV1PlatformGETExternalIpAllocation.from_dict(
                _external_ip_allocation
            )

        external_ip_status_v1_platform_get = cls(
            error=error,
            external_ip_allocation=external_ip_allocation,
        )

        external_ip_status_v1_platform_get.additional_properties = d
        return external_ip_status_v1_platform_get
