...
from ..models.network_storage_spec_wrapper_v1_platform_get_access_mode import (
    NetworkStorageSpecWrapperV1PlatformGETAccessMode,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="NetworkStorageSpecWrapperV1PlatformGET")


@_attrs_define
class NetworkStorageSpecWrapperV1PlatformGET:
    """
    Attributes:
        access_mode (Union[Unset, NetworkStorageSpecWrapperV1PlatformGETAccessMode]): Allowed accessmode of storage
    ...
    access_mode: Union[Unset, NetworkStorageSpecWrapperV1PlatformGETAccessMode] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        access_mode: Union[Unset, NetworkStorageSpecWrapperV1PlatformGETAccessMode]
        if isinstance(_access_mode, Unset):
            access_mode = UNSET
        else:
            access_mode = NetworkStorageSpecWrapperV1PlatformGETAccessMode(_access_mode)
        ...
        network_storage_spec_wrapper_v1_platform_get = cls(
        ...
        network_storage_spec_wrapper_v1_platform_get.additional_properties = d
        return network_storage_spec_wrapper_v1_platform_get
