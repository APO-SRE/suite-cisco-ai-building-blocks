...
from ..models.cluster_node_v4_federation_get_current_state import ClusterNodeV4FederationGETCurrentState
from ..types import UNSET, Unset

T = TypeVar("T", bound="ClusterNodeV4FederationGET")


@_attrs_define
class ClusterNodeV4FederationGET:
    """
    Attributes:
        current_state (Union[Unset, ClusterNodeV4FederationGETCurrentState]): Current state of the node
    ...
    current_state: Union[Unset, ClusterNodeV4FederationGETCurrentState] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        current_state: Union[Unset, ClusterNodeV4FederationGETCurrentState]
        if isinstance(_current_state, Unset):
            current_state = UNSET
        else:
            current_state = ClusterNodeV4FederationGETCurrentState(_current_state)
        ...
        cluster_node_v4_federation_get = cls(
        ...
        cluster_node_v4_federation_get.additional_properties = d
        return cluster_node_v4_federation_get
