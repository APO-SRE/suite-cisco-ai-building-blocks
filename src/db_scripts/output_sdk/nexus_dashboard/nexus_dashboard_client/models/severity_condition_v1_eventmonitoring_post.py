...
from ..models.severity_condition_v1_eventmonitoring_post_severity import SeverityConditionV1EventmonitoringPOSTSeverity
from ..types import UNSET, Unset

T = TypeVar("T", bound="SeverityConditionV1EventmonitoringPOST")


@_attrs_define
class SeverityConditionV1EventmonitoringPOST:
    ...
    Attributes:
        ...
        severity (Union[Unset, SeverityConditionV1EventmonitoringPOSTSeverity]): Severity of the alert to be raised
    """
    ...
    severity: Union[Unset, SeverityConditionV1EventmonitoringPOSTSeverity] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        severity: Union[Unset, SeverityConditionV1EventmonitoringPOSTSeverity]
        if isinstance(_severity, Unset):
            severity = UNSET
        else:
            severity = SeverityConditionV1EventmonitoringPOSTSeverity(_severity)

        severity_condition_v1_eventmonitoring_post = cls(
        ...
        severity_condition_v1_eventmonitoring_post.additional_properties = d
        return severity_condition_v1_eventmonitoring_post
