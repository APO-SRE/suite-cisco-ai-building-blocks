...
T = TypeVar("T", bound="ClusterSpecNetworkV1PlatformPUT")


@_attrs_define
class ClusterSpecNetworkV1PlatformPUT:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cluster_spec_network_v1_platform_put = cls(
            subnet=subnet,
            subnetv6=subnetv6,
        )

        cluster_spec_network_v1_platform_put.additional_properties = d
        return cluster_spec_network_v1_platform_put
