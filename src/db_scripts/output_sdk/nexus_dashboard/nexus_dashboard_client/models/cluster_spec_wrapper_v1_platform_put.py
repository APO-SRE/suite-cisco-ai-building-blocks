...
from ..models.cluster_spec_wrapper_v1_platform_put_network_mode import ClusterSpecWrapperV1PlatformPUTNetworkMode
...
T = TypeVar("T", bound="ClusterSpecWrapperV1PlatformPUT")


@_attrs_define
class ClusterSpecWrapperV1PlatformPUT:
    """
    Attributes:
        ...
        network_mode (Union[Unset, ClusterSpecWrapperV1PlatformPUTNetworkMode]): Shows what IP protocols are configured
            on this cluster
    ...
    network_mode: Union[Unset, ClusterSpecWrapperV1PlatformPUTNetworkMode] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        network_mode: Union[Unset, ClusterSpecWrapperV1PlatformPUTNetworkMode]
        if isinstance(_network_mode, Unset):
            network_mode = UNSET
        else:
            network_mode = ClusterSpecWrapperV1PlatformPUTNetworkMode(_network_mode)
        ...
        cluster_spec_wrapper_v1_platform_put = cls(
        ...
        cluster_spec_wrapper_v1_platform_put.additional_properties = d
        return cluster_spec_wrapper_v1_platform_put
