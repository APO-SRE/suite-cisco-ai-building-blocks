...
T = TypeVar("T", bound="DirectoryEntrySpecV1ArgoCiscoComGET")


@_attrs_define
class DirectoryEntrySpecV1ArgoCiscoComGET:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        directory_entry_spec_v1_argo_cisco_com_get = cls(
        ...
        directory_entry_spec_v1_argo_cisco_com_get.additional_properties = d
        return directory_entry_spec_v1_argo_cisco_com_get
