...
T = TypeVar("T", bound="FabricSpecV4SitemanagementPUT")


@_attrs_define
class FabricSpecV4SitemanagementPUT:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fabric_spec_v4_sitemanagement_put = cls(
        ...
        fabric_spec_v4_sitemanagement_put.additional_properties = d
        return fabric_spec_v4_sitemanagement_put
