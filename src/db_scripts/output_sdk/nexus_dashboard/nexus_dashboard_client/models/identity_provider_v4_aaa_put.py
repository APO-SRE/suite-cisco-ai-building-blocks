...
from ..models.identity_provider_v4_aaa_put_auth_type import IdentityProviderV4AaaPUTAuthType
from ..types import UNSET, Unset

T = TypeVar("T", bound="IdentityProviderV4AaaPUT")


@_attrs_define
class IdentityProviderV4AaaPUT:
    """
    Attributes:
        auth_type (Union[Unset, IdentityProviderV4AaaPUTAuthType]): OIDC authentication mechanism
    ...
    auth_type: Union[Unset, IdentityProviderV4AaaPUTAuthType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        auth_type: Union[Unset, IdentityProviderV4AaaPUTAuthType]
        if isinstance(_auth_type, Unset):
            auth_type = UNSET
        else:
            auth_type = IdentityProviderV4AaaPUTAuthType(_auth_type)
        ...
        identity_provider_v4_aaa_put = cls(
            auth_type=auth_type,
            client_id=client_id,
        ...
        identity_provider_v4_aaa_put.additional_properties = d
        return identity_provider_v4_aaa_put
