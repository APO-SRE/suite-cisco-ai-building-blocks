...
T = TypeVar("T", bound="CertificateMetadataV4AaaPUT")


@_attrs_define
class CertificateMetadataV4AaaPUT:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        certificate_metadata_v4_aaa_put = cls(
        ...
        certificate_metadata_v4_aaa_put.additional_properties = d
        return certificate_metadata_v4_aaa_put
