...
T = TypeVar("T", bound="RemoteUserSpecV4AaaPOST")


@_attrs_define
class RemoteUserSpecV4AaaPOST:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        remote_user_spec_v4_aaa_post = cls(
        ...
        remote_user_spec_v4_aaa_post.additional_properties = d
        return remote_user_spec_v4_aaa_post
