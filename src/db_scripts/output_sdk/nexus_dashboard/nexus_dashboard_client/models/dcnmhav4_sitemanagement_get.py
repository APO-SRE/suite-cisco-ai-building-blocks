...
T = TypeVar("T", bound="DCNMHAV4SitemanagementGET")


@_attrs_define
class DCNMHAV4SitemanagementGET:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dcnmhav4_sitemanagement_get = cls(
            inband_ip=inband_ip,
            mode=mode,
        ...
        dcnmhav4_sitemanagement_get.additional_properties = d
        return dcnmhav4_sitemanagement_get
