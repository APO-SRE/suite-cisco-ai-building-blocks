...
T = TypeVar("T", bound="SyslogSyncStatusV1PlatformGET")


@_attrs_define
class SyslogSyncStatusV1PlatformGET:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        syslog_sync_status_v1_platform_get = cls(
            error=error,
        )

        syslog_sync_status_v1_platform_get.additional_properties = d
        return syslog_sync_status_v1_platform_get
