...
T = TypeVar("T", bound="GroupRestrictionsV4SitemanagementGET")


@_attrs_define
class GroupRestrictionsV4SitemanagementGET:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        group_restrictions_v4_sitemanagement_get = cls(
            allow_non_empty_delete=allow_non_empty_delete,
            allow_remote_members=allow_remote_members,
        )

        group_restrictions_v4_sitemanagement_get.additional_properties = d
        return group_restrictions_v4_sitemanagement_get
