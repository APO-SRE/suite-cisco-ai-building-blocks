...
T = TypeVar("T", bound="SiteStatusV4SitemanagementGET")


@_attrs_define
class SiteStatusV4SitemanagementGET:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_status_v4_sitemanagement_get = cls(
            apps=apps,
        ...
        site_status_v4_sitemanagement_get.additional_properties = d
        return site_status_v4_sitemanagement_get
