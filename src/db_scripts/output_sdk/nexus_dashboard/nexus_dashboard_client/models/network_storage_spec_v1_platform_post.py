...
from ..models.network_storage_spec_v1_platform_post_access_mode import NetworkStorageSpecV1PlatformPOSTAccessMode
from ..types import UNSET, Unset

T = TypeVar("T", bound="NetworkStorageSpecV1PlatformPOST")


@_attrs_define
class NetworkStorageSpecV1PlatformPOST:
    """Network Storage configuration

    Attributes:
        access_mode (Union[Unset, NetworkStorageSpecV1PlatformPOSTAccessMode]): Allowed accessmode of storage
    ...
    access_mode: Union[Unset, NetworkStorageSpecV1PlatformPOSTAccessMode] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        access_mode: Union[Unset, NetworkStorageSpecV1PlatformPOSTAccessMode]
        if isinstance(_access_mode, Unset):
            access_mode = UNSET
        else:
            access_mode = NetworkStorageSpecV1PlatformPOSTAccessMode(_access_mode)
        ...
        network_storage_spec_v1_platform_post = cls(
        ...
        network_storage_spec_v1_platform_post.additional_properties = d
        return network_storage_spec_v1_platform_post
