...
T = TypeVar("T", bound="CloudACIStatusV4SitemanagementPUT")


@_attrs_define
class CloudACIStatusV4SitemanagementPUT:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cloud_aci_status_v4_sitemanagement_put = cls(
        ...
        cloud_aci_status_v4_sitemanagement_put.additional_properties = d
        return cloud_aci_status_v4_sitemanagement_put
