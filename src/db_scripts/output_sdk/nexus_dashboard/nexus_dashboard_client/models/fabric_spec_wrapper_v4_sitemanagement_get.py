...
T = TypeVar("T", bound="FabricSpecWrapperV4SitemanagementGET")


@_attrs_define
class FabricSpecWrapperV4SitemanagementGET:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fabric_spec_wrapper_v4_sitemanagement_get = cls(
        ...
        fabric_spec_wrapper_v4_sitemanagement_get.additional_properties = d
        return fabric_spec_wrapper_v4_sitemanagement_get
