...
from ..models.cluster_status_wrapper_v2_platform_post_state import ClusterStatusWrapperV2PlatformPOSTState
...
T = TypeVar("T", bound="ClusterStatusWrapperV2PlatformPOST")


@_attrs_define
class ClusterStatusWrapperV2PlatformPOST:
    """
    Attributes:
        ...
        state (Union[Unset, ClusterStatusWrapperV2PlatformPOSTState]): State of dual-stack mode in cluster
    ...
    state: Union[Unset, ClusterStatusWrapperV2PlatformPOSTState] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        state: Union[Unset, ClusterStatusWrapperV2PlatformPOSTState]
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = ClusterStatusWrapperV2PlatformPOSTState(_state)

        target_version = d.pop("targetVersion", UNSET)

        uuid = d.pop("uuid", UNSET)

        cluster_status_wrapper_v2_platform_post = cls(
        ...
        cluster_status_wrapper_v2_platform_post.additional_properties = d
        return cluster_status_wrapper_v2_platform_post
