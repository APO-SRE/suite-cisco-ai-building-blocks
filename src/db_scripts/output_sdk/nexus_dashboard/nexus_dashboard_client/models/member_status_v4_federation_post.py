...
from ..models.member_status_v4_federation_post_reachability import MemberStatusV4FederationPOSTReachability
...
T = TypeVar("T", bound="MemberStatusV4FederationPOST")


@_attrs_define
class MemberStatusV4FederationPOST:
    """
    Attributes:
        ...
        reachability (Union[Unset, MemberStatusV4FederationPOSTReachability]): Member reachability status -
            Unknown/Up/Down
    """
    ...
    reachability: Union[Unset, MemberStatusV4FederationPOSTReachability] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reachability: Union[Unset, MemberStatusV4FederationPOSTReachability]
        if isinstance(_reachability, Unset):
            reachability = UNSET
        else:
            reachability = MemberStatusV4FederationPOSTReachability(_reachability)

        member_status_v4_federation_post = cls(
        ...
        member_status_v4_federation_post.additional_properties = d
        return member_status_v4_federation_post
