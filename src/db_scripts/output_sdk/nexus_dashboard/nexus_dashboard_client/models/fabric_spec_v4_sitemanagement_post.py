...
T = TypeVar("T", bound="FabricSpecV4SitemanagementPOST")


@_attrs_define
class FabricSpecV4SitemanagementPOST:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fabric_spec_v4_sitemanagement_post = cls(
        ...
        fabric_spec_v4_sitemanagement_post.additional_properties = d
        return fabric_spec_v4_sitemanagement_post
