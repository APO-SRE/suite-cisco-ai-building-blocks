...
if TYPE_CHECKING:
    from ..models.severity_condition_v1_eventmonitoring_post import SeverityConditionV1EventmonitoringPOST


T = TypeVar("T", bound="AlertConfigV1EventmonitoringPOST")


@_attrs_define
class AlertConfigV1EventmonitoringPOST:
    ...
    Attributes:
        ...
        severity_conditions (Union[Unset, list['SeverityConditionV1EventmonitoringPOST']]): Types of severity conditions
            to track
    """
    ...
    severity_conditions: Union[Unset, list["SeverityConditionV1EventmonitoringPOST"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for severity_conditions_item_data in _severity_conditions or []:
            severity_conditions_item = SeverityConditionV1EventmonitoringPOST.from_dict(severity_conditions_item_data)

            severity_conditions.append(severity_conditions_item)

        alert_config_v1_eventmonitoring_post = cls(
        ...
        alert_config_v1_eventmonitoring_post.additional_properties = d
        return alert_config_v1_eventmonitoring_post
