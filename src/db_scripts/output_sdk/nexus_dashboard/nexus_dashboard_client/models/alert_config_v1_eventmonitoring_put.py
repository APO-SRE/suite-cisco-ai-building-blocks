...
if TYPE_CHECKING:
    from ..models.severity_condition_v1_eventmonitoring_put import SeverityConditionV1EventmonitoringPUT


T = TypeVar("T", bound="AlertConfigV1EventmonitoringPUT")


@_attrs_define
class AlertConfigV1EventmonitoringPUT:
    ...
    Attributes:
        ...
        severity_conditions (Union[Unset, list['SeverityConditionV1EventmonitoringPUT']]): Types of severity conditions
            to track
    """
    ...
    severity_conditions: Union[Unset, list["SeverityConditionV1EventmonitoringPUT"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for severity_conditions_item_data in _severity_conditions or []:
            severity_conditions_item = SeverityConditionV1EventmonitoringPUT.from_dict(severity_conditions_item_data)

            severity_conditions.append(severity_conditions_item)

        alert_config_v1_eventmonitoring_put = cls(
        ...
        alert_config_v1_eventmonitoring_put.additional_properties = d
        return alert_config_v1_eventmonitoring_put
