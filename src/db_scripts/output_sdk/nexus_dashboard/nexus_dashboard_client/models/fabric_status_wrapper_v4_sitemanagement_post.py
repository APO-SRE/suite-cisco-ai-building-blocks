...
T = TypeVar("T", bound="FabricStatusWrapperV4SitemanagementPOST")


@_attrs_define
class FabricStatusWrapperV4SitemanagementPOST:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fabric_status_wrapper_v4_sitemanagement_post = cls(
            site_list=site_list,
            site_type=site_type,
        )

        fabric_status_wrapper_v4_sitemanagement_post.additional_properties = d
        return fabric_status_wrapper_v4_sitemanagement_post
