...
T = TypeVar("T", bound="EventStoreV1EventmonitoringGET")


@_attrs_define
class EventStoreV1EventmonitoringGET:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        event_store_v1_eventmonitoring_get = cls(
            current_event_occurrences=current_event_occurrences,
            total_event_count=total_event_count,
        )

        event_store_v1_eventmonitoring_get.additional_properties = d
        return event_store_v1_eventmonitoring_get
