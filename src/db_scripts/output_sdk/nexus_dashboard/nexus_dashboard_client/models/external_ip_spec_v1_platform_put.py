...
T = TypeVar("T", bound="ExternalIpSpecV1PlatformPUT")


@_attrs_define
class ExternalIpSpecV1PlatformPUT:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        external_ip_spec_v1_platform_put = cls(
            ip=ip,
            name=name,
            target_network=target_network,
        )

        external_ip_spec_v1_platform_put.additional_properties = d
        return external_ip_spec_v1_platform_put
