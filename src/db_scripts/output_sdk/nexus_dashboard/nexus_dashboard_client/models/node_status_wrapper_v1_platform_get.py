...
from ..models.node_status_wrapper_v1_platform_get_machine_type import NodeStatusWrapperV1PlatformGETMachineType
from ..models.node_status_wrapper_v1_platform_get_platform_type import NodeStatusWrapperV1PlatformGETPlatformType
from ..models.node_status_wrapper_v1_platform_get_state import NodeStatusWrapperV1PlatformGETState
...
T = TypeVar("T", bound="NodeStatusWrapperV1PlatformGET")


@_attrs_define
class NodeStatusWrapperV1PlatformGET:
    """
    Attributes:
        ...
        machine_type (Union[Unset, NodeStatusWrapperV1PlatformGETMachineType]): Node hardware type
        model (Union[Unset, str]): Node model
        platform_type (Union[Unset, NodeStatusWrapperV1PlatformGETPlatformType]): Node platform type
        serf_status (Union[Unset, str]): Node's Serf status
        state (Union[Unset, NodeStatusWrapperV1PlatformGETState]): Node operational Status
    ...
    machine_type: Union[Unset, NodeStatusWrapperV1PlatformGETMachineType] = UNSET
    model: Union[Unset, str] = UNSET
    platform_type: Union[Unset, NodeStatusWrapperV1PlatformGETPlatformType] = UNSET
    serf_status: Union[Unset, str] = UNSET
    state: Union[Unset, NodeStatusWrapperV1PlatformGETState] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        machine_type: Union[Unset, NodeStatusWrapperV1PlatformGETMachineType]
        if isinstance(_machine_type, Unset):
            machine_type = UNSET
        else:
            machine_type = NodeStatusWrapperV1PlatformGETMachineType(_machine_type)

        model = d.pop("model", UNSET)

        _platform_type = d.pop("platformType", UNSET)
        platform_type: Union[Unset, NodeStatusWrapperV1PlatformGETPlatformType]
        if isinstance(_platform_type, Unset):
            platform_type = UNSET
        else:
            platform_type = NodeStatusWrapperV1PlatformGETPlatformType(_platform_type)

        serf_status = d.pop("serfStatus", UNSET)

        _state = d.pop("state", UNSET)
        state: Union[Unset, NodeStatusWrapperV1PlatformGETState]
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = NodeStatusWrapperV1PlatformGETState(_state)

        uuid = d.pop("uuid", UNSET)

        version = d.pop("version", UNSET)

        node_status_wrapper_v1_platform_get = cls(
            boot_time=boot_time,
        ...
        node_status_wrapper_v1_platform_get.additional_properties = d
        return node_status_wrapper_v1_platform_get
