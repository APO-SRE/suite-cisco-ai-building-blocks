...
T = TypeVar("T", bound="ClusterSpecNetworkV1PlatformGET")


@_attrs_define
class ClusterSpecNetworkV1PlatformGET:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cluster_spec_network_v1_platform_get = cls(
            subnet=subnet,
            subnetv6=subnetv6,
        )

        cluster_spec_network_v1_platform_get.additional_properties = d
        return cluster_spec_network_v1_platform_get
