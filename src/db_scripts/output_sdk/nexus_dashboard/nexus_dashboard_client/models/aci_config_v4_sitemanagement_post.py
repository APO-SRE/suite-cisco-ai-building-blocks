...
T = TypeVar("T", bound="ACIConfigV4SitemanagementPOST")


@_attrs_define
class ACIConfigV4SitemanagementPOST:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        aci_config_v4_sitemanagement_post = cls(
            inband_epgdn=inband_epgdn,
        )

        aci_config_v4_sitemanagement_post.additional_properties = d
        return aci_config_v4_sitemanagement_post
