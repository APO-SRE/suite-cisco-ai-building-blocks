...
from ..models.member_status_v4_federation_put_reachability import MemberStatusV4FederationPUTReachability
...
T = TypeVar("T", bound="MemberStatusV4FederationPUT")


@_attrs_define
class MemberStatusV4FederationPUT:
    """
    Attributes:
        ...
        reachability (Union[Unset, MemberStatusV4FederationPUTReachability]): Member reachability status -
            Unknown/Up/Down
    """
    ...
    reachability: Union[Unset, MemberStatusV4FederationPUTReachability] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reachability: Union[Unset, MemberStatusV4FederationPUTReachability]
        if isinstance(_reachability, Unset):
            reachability = UNSET
        else:
            reachability = MemberStatusV4FederationPUTReachability(_reachability)

        member_status_v4_federation_put = cls(
        ...
        member_status_v4_federation_put.additional_properties = d
        return member_status_v4_federation_put
