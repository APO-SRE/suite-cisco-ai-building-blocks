...
T = TypeVar("T", bound="DCNMConfigV4SitemanagementPOST")


@_attrs_define
class DCNMConfigV4SitemanagementPOST:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dcnm_config_v4_sitemanagement_post = cls(
            fabric_name=fabric_name,
            fabric_technology=fabric_technology,
            fabric_type=fabric_type,
        )

        dcnm_config_v4_sitemanagement_post.additional_properties = d
        return dcnm_config_v4_sitemanagement_post
