...
from ..models.cluster_node_v4_federation_put_current_state import ClusterNodeV4FederationPUTCurrentState
from ..types import UNSET, Unset

T = TypeVar("T", bound="ClusterNodeV4FederationPUT")


@_attrs_define
class ClusterNodeV4FederationPUT:
    """
    Attributes:
        current_state (Union[Unset, ClusterNodeV4FederationPUTCurrentState]): Current state of the node
    ...
    current_state: Union[Unset, ClusterNodeV4FederationPUTCurrentState] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        current_state: Union[Unset, ClusterNodeV4FederationPUTCurrentState]
        if isinstance(_current_state, Unset):
            current_state = UNSET
        else:
            current_state = ClusterNodeV4FederationPUTCurrentState(_current_state)
        ...
        cluster_node_v4_federation_put = cls(
        ...
        cluster_node_v4_federation_put.additional_properties = d
        return cluster_node_v4_federation_put
