...
if TYPE_CHECKING:
    from ..models.alert_config_v1_eventmonitoring_post import AlertConfigV1EventmonitoringPOST
    from ..models.retention_policy_v1_eventmonitoring_post import RetentionPolicyV1EventmonitoringPOST
    from ..models.trigger_group_v1_eventmonitoring_post import TriggerGroupV1EventmonitoringPOST


T = TypeVar("T", bound="EventConfigSpecWrapperV1EventmonitoringPOST")


@_attrs_define
class EventConfigSpecWrapperV1EventmonitoringPOST:
    """
    Attributes:
        id (str): domain.metaName appended with name for event configuration
        alert_config (Union[Unset, AlertConfigV1EventmonitoringPOST]): Alert configuration being monitored as part of
            event configuration
        ...
        retention_policy (Union[Unset, RetentionPolicyV1EventmonitoringPOST]): Retention policy for the generated event
            records as part of the parent event configuration
        source (Union[Unset, str]): Source of the issue
        trigger_groups (Union[Unset, list['TriggerGroupV1EventmonitoringPOST']]): List of triggers that govern the
            stream types where the alert can be broadcasted
    """

    id: str
    alert_config: Union[Unset, "AlertConfigV1EventmonitoringPOST"] = UNSET
    ...
    retention_policy: Union[Unset, "RetentionPolicyV1EventmonitoringPOST"] = UNSET
    source: Union[Unset, str] = UNSET
    trigger_groups: Union[Unset, list["TriggerGroupV1EventmonitoringPOST"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        alert_config: Union[Unset, AlertConfigV1EventmonitoringPOST]
        if isinstance(_alert_config, Unset):
            alert_config = UNSET
        else:
            alert_config = AlertConfigV1EventmonitoringPOST.from_dict(_alert_config)
        ...
        retention_policy: Union[Unset, RetentionPolicyV1EventmonitoringPOST]
        if isinstance(_retention_policy, Unset):
            retention_policy = UNSET
        else:
            retention_policy = RetentionPolicyV1EventmonitoringPOST.from_dict(_retention_policy)
        ...
        for trigger_groups_item_data in _trigger_groups or []:
            trigger_groups_item = TriggerGroupV1EventmonitoringPOST.from_dict(trigger_groups_item_data)

            trigger_groups.append(trigger_groups_item)

        event_config_spec_wrapper_v1_eventmonitoring_post = cls(
            id=id,
        ...
        event_config_spec_wrapper_v1_eventmonitoring_post.additional_properties = d
        return event_config_spec_wrapper_v1_eventmonitoring_post
