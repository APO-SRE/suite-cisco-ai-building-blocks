...
T = TypeVar("T", bound="UserAPIKeySpecV4AaaGET")


@_attrs_define
class UserAPIKeySpecV4AaaGET:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_api_key_spec_v4_aaa_get = cls(
            api_key=api_key,
        ...
        user_api_key_spec_v4_aaa_get.additional_properties = d
        return user_api_key_spec_v4_aaa_get
