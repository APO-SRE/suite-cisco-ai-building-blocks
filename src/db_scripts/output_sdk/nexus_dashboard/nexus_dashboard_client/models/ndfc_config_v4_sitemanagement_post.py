...
T = TypeVar("T", bound="NDFCConfigV4SitemanagementPOST")


@_attrs_define
class NDFCConfigV4SitemanagementPOST:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ndfc_config_v4_sitemanagement_post = cls(
        ...
        ndfc_config_v4_sitemanagement_post.additional_properties = d
        return ndfc_config_v4_sitemanagement_post
