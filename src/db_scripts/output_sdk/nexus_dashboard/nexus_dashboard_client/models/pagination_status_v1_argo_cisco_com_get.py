...
if TYPE_CHECKING:
    ...
    from ..models.pagination_status_v1_argo_cisco_com_get_intra_type_i_ds import (
        PaginationStatusV1ArgoCiscoComGETIntraTypeIDs,
    )


T = TypeVar("T", bound="PaginationStatusV1ArgoCiscoComGET")


@_attrs_define
class PaginationStatusV1ArgoCiscoComGET:
    """
    Attributes:
        fields_resolve_meta_ptrs (Union[Unset, list[str]]):
        inc (Union[Unset, bool]):
        intra_type_i_ds (Union[Unset, PaginationStatusV1ArgoCiscoComGETIntraTypeIDs]):
    ...
    intra_type_i_ds: Union[Unset, "PaginationStatusV1ArgoCiscoComGETIntraTypeIDs"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_intra_type_i_ds, Unset):
            ...
            intra_type_i_ds = PaginationStatusV1ArgoCiscoComGETIntraTypeIDs.from_dict(_intra_type_i_ds)
        ...
        pagination_status_v1_argo_cisco_com_get = cls(
        ...
        pagination_status_v1_argo_cisco_com_get.additional_properties = d
        return pagination_status_v1_argo_cisco_com_get
