...
if TYPE_CHECKING:
    from ..models.paginated_object_descriptor_v1_argo_cisco_com_put import PaginatedObjectDescriptorV1ArgoCiscoComPUT
    from ..models.pagination_status_wrapper_v1_argo_cisco_com_put_intra_type_i_ds import (
        PaginationStatusWrapperV1ArgoCiscoComPUTIntraTypeIDs,
    )


T = TypeVar("T", bound="PaginationStatusWrapperV1ArgoCiscoComPUT")


@_attrs_define
class PaginationStatusWrapperV1ArgoCiscoComPUT:
    """
    Attributes:
        fields_resolve_meta_ptrs (Union[Unset, list[str]]):
        inc (Union[Unset, bool]):
        intra_type_i_ds (Union[Unset, PaginationStatusWrapperV1ArgoCiscoComPUTIntraTypeIDs]):
        match_expression (Union[Unset, str]):
        order_by (Union[Unset, list[str]]):
        results (Union[Unset, list['PaginatedObjectDescriptorV1ArgoCiscoComPUT']]):
        updated (Union[Unset, str]):
    """

    fields_resolve_meta_ptrs: Union[Unset, list[str]] = UNSET
    inc: Union[Unset, bool] = UNSET
    intra_type_i_ds: Union[Unset, "PaginationStatusWrapperV1ArgoCiscoComPUTIntraTypeIDs"] = UNSET
    match_expression: Union[Unset, str] = UNSET
    order_by: Union[Unset, list[str]] = UNSET
    results: Union[Unset, list["PaginatedObjectDescriptorV1ArgoCiscoComPUT"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.paginated_object_descriptor_v1_argo_cisco_com_put import (
        ...
        if isinstance(_intra_type_i_ds, Unset):
            ...
            intra_type_i_ds = PaginationStatusWrapperV1ArgoCiscoComPUTIntraTypeIDs.from_dict(_intra_type_i_ds)
        ...
        for results_item_data in _results or []:
            results_item = PaginatedObjectDescriptorV1ArgoCiscoComPUT.from_dict(results_item_data)

            results.append(results_item)

        updated = d.pop("updated", UNSET)

        pagination_status_wrapper_v1_argo_cisco_com_put = cls(
        ...
        pagination_status_wrapper_v1_argo_cisco_com_put.additional_properties = d
        return pagination_status_wrapper_v1_argo_cisco_com_put
