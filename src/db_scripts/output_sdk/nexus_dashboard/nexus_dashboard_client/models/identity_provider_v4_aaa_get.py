...
from ..models.identity_provider_v4_aaa_get_auth_type import IdentityProviderV4AaaGETAuthType
from ..types import UNSET, Unset

T = TypeVar("T", bound="IdentityProviderV4AaaGET")


@_attrs_define
class IdentityProviderV4AaaGET:
    """
    Attributes:
        auth_type (Union[Unset, IdentityProviderV4AaaGETAuthType]): OIDC authentication mechanism
    ...
    auth_type: Union[Unset, IdentityProviderV4AaaGETAuthType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        auth_type: Union[Unset, IdentityProviderV4AaaGETAuthType]
        if isinstance(_auth_type, Unset):
            auth_type = UNSET
        else:
            auth_type = IdentityProviderV4AaaGETAuthType(_auth_type)
        ...
        identity_provider_v4_aaa_get = cls(
            auth_type=auth_type,
            client_id=client_id,
        ...
        identity_provider_v4_aaa_get.additional_properties = d
        return identity_provider_v4_aaa_get
