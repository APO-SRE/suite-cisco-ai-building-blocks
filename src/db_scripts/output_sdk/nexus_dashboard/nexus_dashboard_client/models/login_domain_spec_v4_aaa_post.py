...
from ..models.login_domain_spec_v4_aaa_post_realm import LoginDomainSpecV4AaaPOSTRealm
...
T = TypeVar("T", bound="LoginDomainSpecV4AaaPOST")


@_attrs_define
class LoginDomainSpecV4AaaPOST:
    """
    Attributes:
        description (Union[Unset, str]): Description about the login domain
        domain (Union[Unset, str]): Login domain name
        realm (Union[Unset, LoginDomainSpecV4AaaPOSTRealm]): Login domain realm type
    ...
    realm: Union[Unset, LoginDomainSpecV4AaaPOSTRealm] = UNSET
    servers: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        realm: Union[Unset, LoginDomainSpecV4AaaPOSTRealm]
        if isinstance(_realm, Unset):
            realm = UNSET
        else:
            realm = LoginDomainSpecV4AaaPOSTRealm(_realm)
        ...
        login_domain_spec_v4_aaa_post = cls(
        ...
        login_domain_spec_v4_aaa_post.additional_properties = d
        return login_domain_spec_v4_aaa_post
