...
T = TypeVar("T", bound="CloudACIConfigV4SitemanagementPOST")


@_attrs_define
class CloudACIConfigV4SitemanagementPOST:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cloud_aci_config_v4_sitemanagement_post = cls(
            inband_epgdn=inband_epgdn,
        )

        cloud_aci_config_v4_sitemanagement_post.additional_properties = d
        return cloud_aci_config_v4_sitemanagement_post
