...
T = TypeVar("T", bound="CloudACIConfigV4SitemanagementPUT")


@_attrs_define
class CloudACIConfigV4SitemanagementPUT:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cloud_aci_config_v4_sitemanagement_put = cls(
            inband_epgdn=inband_epgdn,
        )

        cloud_aci_config_v4_sitemanagement_put.additional_properties = d
        return cloud_aci_config_v4_sitemanagement_put
