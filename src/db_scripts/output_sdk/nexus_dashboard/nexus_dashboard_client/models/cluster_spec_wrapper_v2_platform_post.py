...
from ..models.cluster_spec_wrapper_v2_platform_post_network_mode import ClusterSpecWrapperV2PlatformPOSTNetworkMode
...
T = TypeVar("T", bound="ClusterSpecWrapperV2PlatformPOST")


@_attrs_define
class ClusterSpecWrapperV2PlatformPOST:
    """
    Attributes:
        ...
        network_mode (Union[Unset, ClusterSpecWrapperV2PlatformPOSTNetworkMode]): Shows what IP protocols are configured
            on this cluster
    ...
    network_mode: Union[Unset, ClusterSpecWrapperV2PlatformPOSTNetworkMode] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        network_mode: Union[Unset, ClusterSpecWrapperV2PlatformPOSTNetworkMode]
        if isinstance(_network_mode, Unset):
            network_mode = UNSET
        else:
            network_mode = ClusterSpecWrapperV2PlatformPOSTNetworkMode(_network_mode)
        ...
        cluster_spec_wrapper_v2_platform_post = cls(
            name=name,
        ...
        cluster_spec_wrapper_v2_platform_post.additional_properties = d
        return cluster_spec_wrapper_v2_platform_post
