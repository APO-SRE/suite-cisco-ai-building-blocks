...
T = TypeVar("T", bound="PostRefreshResponse200")


@_attrs_define
class PostRefreshResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_refresh_response_200.additional_properties = d
        return post_refresh_response_200
