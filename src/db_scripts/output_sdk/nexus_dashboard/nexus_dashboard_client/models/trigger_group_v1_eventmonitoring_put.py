...
T = TypeVar("T", bound="TriggerGroupV1EventmonitoringPUT")


@_attrs_define
class TriggerGroupV1EventmonitoringPUT:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        trigger_group_v1_eventmonitoring_put = cls(
        ...
        trigger_group_v1_eventmonitoring_put.additional_properties = d
        return trigger_group_v1_eventmonitoring_put
