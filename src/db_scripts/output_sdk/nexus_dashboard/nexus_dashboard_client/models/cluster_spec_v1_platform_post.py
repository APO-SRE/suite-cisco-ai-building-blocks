...
from ..models.cluster_spec_v1_platform_post_network_mode import ClusterSpecV1PlatformPOSTNetworkMode
...
T = TypeVar("T", bound="ClusterSpecV1PlatformPOST")


@_attrs_define
class ClusterSpecV1PlatformPOST:
    ...
    Attributes:
        ...
        network_mode (Union[Unset, ClusterSpecV1PlatformPOSTNetworkMode]): Shows what IP protocols are configured on
            this cluster
    ...
    network_mode: Union[Unset, ClusterSpecV1PlatformPOSTNetworkMode] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        network_mode: Union[Unset, ClusterSpecV1PlatformPOSTNetworkMode]
        if isinstance(_network_mode, Unset):
            network_mode = UNSET
        else:
            network_mode = ClusterSpecV1PlatformPOSTNetworkMode(_network_mode)
        ...
        cluster_spec_v1_platform_post = cls(
        ...
        cluster_spec_v1_platform_post.additional_properties = d
        return cluster_spec_v1_platform_post
