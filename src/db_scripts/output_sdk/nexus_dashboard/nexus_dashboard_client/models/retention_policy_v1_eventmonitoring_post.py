...
T = TypeVar("T", bound="RetentionPolicyV1EventmonitoringPOST")


@_attrs_define
class RetentionPolicyV1EventmonitoringPOST:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        retention_policy_v1_eventmonitoring_post = cls(
            count=count,
            duration=duration,
            size=size,
        )

        retention_policy_v1_eventmonitoring_post.additional_properties = d
        return retention_policy_v1_eventmonitoring_post
