...
T = TypeVar("T", bound="MemberSpecWrapperV4FederationPUT")


@_attrs_define
class MemberSpecWrapperV4FederationPUT:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        member_spec_wrapper_v4_federation_put = cls(
            host=host,
        ...
        member_spec_wrapper_v4_federation_put.additional_properties = d
        return member_spec_wrapper_v4_federation_put
