...
T = TypeVar("T", bound="SwitchV4SitemanagementPOST")


@_attrs_define
class SwitchV4SitemanagementPOST:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        switch_v4_sitemanagement_post = cls(
            inband_ip=inband_ip,
            model=model,
        ...
        switch_v4_sitemanagement_post.additional_properties = d
        return switch_v4_sitemanagement_post
