...
T = TypeVar("T", bound="FabricResponseStatusV4SitemanagementGET")


@_attrs_define
class FabricResponseStatusV4SitemanagementGET:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fabric_response_status_v4_sitemanagement_get = cls(
            site_list=site_list,
            site_type=site_type,
        )

        fabric_response_status_v4_sitemanagement_get.additional_properties = d
        return fabric_response_status_v4_sitemanagement_get
