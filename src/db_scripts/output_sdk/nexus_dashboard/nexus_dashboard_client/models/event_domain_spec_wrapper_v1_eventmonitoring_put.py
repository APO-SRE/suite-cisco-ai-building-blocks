...
T = TypeVar("T", bound="EventDomainSpecWrapperV1EventmonitoringPUT")


@_attrs_define
class EventDomainSpecWrapperV1EventmonitoringPUT:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        event_domain_spec_wrapper_v1_eventmonitoring_put = cls(
            event_configs=event_configs,
            meta_name=meta_name,
        )

        event_domain_spec_wrapper_v1_eventmonitoring_put.additional_properties = d
        return event_domain_spec_wrapper_v1_eventmonitoring_put
