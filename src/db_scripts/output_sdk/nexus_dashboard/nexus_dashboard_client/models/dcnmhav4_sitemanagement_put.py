...
T = TypeVar("T", bound="DCNMHAV4SitemanagementPUT")


@_attrs_define
class DCNMHAV4SitemanagementPUT:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dcnmhav4_sitemanagement_put = cls(
            inband_ip=inband_ip,
            mode=mode,
        ...
        dcnmhav4_sitemanagement_put.additional_properties = d
        return dcnmhav4_sitemanagement_put
