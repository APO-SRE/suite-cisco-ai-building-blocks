...
T = TypeVar("T", bound="LocalUserSpecV4AaaPUT")


@_attrs_define
class LocalUserSpecV4AaaPUT:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        local_user_spec_v4_aaa_put = cls(
            email=email,
        ...
        local_user_spec_v4_aaa_put.additional_properties = d
        return local_user_spec_v4_aaa_put
