...
if TYPE_CHECKING:
    from ..models.http_server_options_v4_aaa_post import HTTPServerOptionsV4AaaPOST


T = TypeVar("T", bound="GatewayConfigurationSpecWrapperV4AaaPOST")


@_attrs_define
class GatewayConfigurationSpecWrapperV4AaaPOST:
    """
    Attributes:
        name (str): APIGW Config Name
        http_server_options (Union[Unset, HTTPServerOptionsV4AaaPOST]):
    ...
    name: str
    http_server_options: Union[Unset, "HTTPServerOptionsV4AaaPOST"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_http_server_options, Unset):
            ...
            http_server_options = HTTPServerOptionsV4AaaPOST.from_dict(_http_server_options)
        ...
        gateway_configuration_spec_wrapper_v4_aaa_post = cls(
            name=name,
        ...
        gateway_configuration_spec_wrapper_v4_aaa_post.additional_properties = d
        return gateway_configuration_spec_wrapper_v4_aaa_post
