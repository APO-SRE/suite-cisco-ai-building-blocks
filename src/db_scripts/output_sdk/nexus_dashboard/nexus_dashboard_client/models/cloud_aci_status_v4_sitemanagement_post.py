...
T = TypeVar("T", bound="CloudACIStatusV4SitemanagementPOST")


@_attrs_define
class CloudACIStatusV4SitemanagementPOST:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cloud_aci_status_v4_sitemanagement_post = cls(
        ...
        cloud_aci_status_v4_sitemanagement_post.additional_properties = d
        return cloud_aci_status_v4_sitemanagement_post
