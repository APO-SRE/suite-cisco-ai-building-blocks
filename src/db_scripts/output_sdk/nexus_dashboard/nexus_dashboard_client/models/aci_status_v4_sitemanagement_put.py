...
T = TypeVar("T", bound="ACIStatusV4SitemanagementPUT")


@_attrs_define
class ACIStatusV4SitemanagementPUT:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        aci_status_v4_sitemanagement_put = cls(
            app_user_name=app_user_name,
        )

        aci_status_v4_sitemanagement_put.additional_properties = d
        return aci_status_v4_sitemanagement_put
