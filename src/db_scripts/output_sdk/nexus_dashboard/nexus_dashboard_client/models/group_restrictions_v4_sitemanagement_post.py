...
T = TypeVar("T", bound="GroupRestrictionsV4SitemanagementPOST")


@_attrs_define
class GroupRestrictionsV4SitemanagementPOST:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        group_restrictions_v4_sitemanagement_post = cls(
            allow_non_empty_delete=allow_non_empty_delete,
            allow_remote_members=allow_remote_members,
        )

        group_restrictions_v4_sitemanagement_post.additional_properties = d
        return group_restrictions_v4_sitemanagement_post
