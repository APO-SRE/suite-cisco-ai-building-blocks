...
T = TypeVar("T", bound="ExternalIpSpecV1PlatformPOST")


@_attrs_define
class ExternalIpSpecV1PlatformPOST:
    """Resource that represents configuration for external IPs allocated for a given target network
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        external_ip_spec_v1_platform_post = cls(
            ip=ip,
            name=name,
            target_network=target_network,
        )

        external_ip_spec_v1_platform_post.additional_properties = d
        return external_ip_spec_v1_platform_post
