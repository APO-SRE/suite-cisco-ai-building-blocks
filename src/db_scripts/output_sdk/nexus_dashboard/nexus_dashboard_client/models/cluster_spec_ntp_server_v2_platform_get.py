...
T = TypeVar("T", bound="ClusterSpecNTPServerV2PlatformGET")


@_attrs_define
class ClusterSpecNTPServerV2PlatformGET:
    """Cluster NTP Server
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cluster_spec_ntp_server_v2_platform_get = cls(
            host=host,
            key_id=key_id,
            prefer=prefer,
        )

        cluster_spec_ntp_server_v2_platform_get.additional_properties = d
        return cluster_spec_ntp_server_v2_platform_get
