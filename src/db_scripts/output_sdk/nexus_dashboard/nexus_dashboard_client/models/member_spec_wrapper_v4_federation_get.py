...
T = TypeVar("T", bound="MemberSpecWrapperV4FederationGET")


@_attrs_define
class MemberSpecWrapperV4FederationGET:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        member_spec_wrapper_v4_federation_get = cls(
            host=host,
        ...
        member_spec_wrapper_v4_federation_get.additional_properties = d
        return member_spec_wrapper_v4_federation_get
