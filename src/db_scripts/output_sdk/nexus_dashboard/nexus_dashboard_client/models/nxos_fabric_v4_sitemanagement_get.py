...
T = TypeVar("T", bound="NXOSFabricV4SitemanagementGET")


@_attrs_define
class NXOSFabricV4SitemanagementGET:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nxos_fabric_v4_sitemanagement_get = cls(
            name=name,
            read_only=read_only,
            site_id=site_id,
        ...
        nxos_fabric_v4_sitemanagement_get.additional_properties = d
        return nxos_fabric_v4_sitemanagement_get
