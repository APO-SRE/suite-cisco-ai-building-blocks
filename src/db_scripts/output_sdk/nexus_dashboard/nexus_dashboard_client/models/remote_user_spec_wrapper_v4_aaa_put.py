...
T = TypeVar("T", bound="RemoteUserSpecWrapperV4AaaPUT")


@_attrs_define
class RemoteUserSpecWrapperV4AaaPUT:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        remote_user_spec_wrapper_v4_aaa_put = cls(
        ...
        remote_user_spec_wrapper_v4_aaa_put.additional_properties = d
        return remote_user_spec_wrapper_v4_aaa_put
