...
T = TypeVar("T", bound="MemberSpecV4FederationPUT")


@_attrs_define
class MemberSpecV4FederationPUT:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        member_spec_v4_federation_put = cls(
            host=host,
        ...
        member_spec_v4_federation_put.additional_properties = d
        return member_spec_v4_federation_put
