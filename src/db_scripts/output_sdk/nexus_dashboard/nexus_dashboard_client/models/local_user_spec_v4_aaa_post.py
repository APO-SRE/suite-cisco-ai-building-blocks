...
T = TypeVar("T", bound="LocalUserSpecV4AaaPOST")


@_attrs_define
class LocalUserSpecV4AaaPOST:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        local_user_spec_v4_aaa_post = cls(
            email=email,
        ...
        local_user_spec_v4_aaa_post.additional_properties = d
        return local_user_spec_v4_aaa_post
