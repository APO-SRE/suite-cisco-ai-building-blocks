...
from ..models.node_spec_v1_platform_get_role import NodeSpecV1PlatformGETRole
...
T = TypeVar("T", bound="NodeSpecV1PlatformGET")


@_attrs_define
class NodeSpecV1PlatformGET:
    """Node configuration
    ...
    Attributes:
        ...
        role (Union[Unset, NodeSpecV1PlatformGETRole]): Node role
    ...
    role: Union[Unset, NodeSpecV1PlatformGETRole] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        role: Union[Unset, NodeSpecV1PlatformGETRole]
        if isinstance(_role, Unset):
            role = UNSET
        else:
            role = NodeSpecV1PlatformGETRole(_role)

        serial_number = d.pop("serialNumber", UNSET)

        node_spec_v1_platform_get = cls(
        ...
        node_spec_v1_platform_get.additional_properties = d
        return node_spec_v1_platform_get
