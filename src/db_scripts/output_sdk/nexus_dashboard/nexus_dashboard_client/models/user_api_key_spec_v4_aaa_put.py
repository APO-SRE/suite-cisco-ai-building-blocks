...
T = TypeVar("T", bound="UserAPIKeySpecV4AaaPUT")


@_attrs_define
class UserAPIKeySpecV4AaaPUT:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_api_key_spec_v4_aaa_put = cls(
            api_key=api_key,
            api_key_name=api_key_name,
            uuid=uuid,
        )

        user_api_key_spec_v4_aaa_put.additional_properties = d
        return user_api_key_spec_v4_aaa_put
