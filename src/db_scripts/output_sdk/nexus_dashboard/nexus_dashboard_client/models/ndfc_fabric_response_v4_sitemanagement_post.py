...
T = TypeVar("T", bound="NDFCFabricResponseV4SitemanagementPOST")


@_attrs_define
class NDFCFabricResponseV4SitemanagementPOST:
    """
    Attributes:
        in_use (Union[Unset, bool]): NDFC Site already on-boarded
        name (Union[Unset, str]): NDFC Site/Fabric name
        parent_name (Union[Unset, str]): NDFC fabric parent name
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ndfc_fabric_response_v4_sitemanagement_post = cls(
            in_use=in_use,
            name=name,
        ...
        ndfc_fabric_response_v4_sitemanagement_post.additional_properties = d
        return ndfc_fabric_response_v4_sitemanagement_post
