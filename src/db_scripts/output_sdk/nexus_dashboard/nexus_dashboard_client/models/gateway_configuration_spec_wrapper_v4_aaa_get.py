...
if TYPE_CHECKING:
    from ..models.http_server_options_v4_aaa_get import HTTPServerOptionsV4AaaGET


T = TypeVar("T", bound="GatewayConfigurationSpecWrapperV4AaaGET")


@_attrs_define
class GatewayConfigurationSpecWrapperV4AaaGET:
    """
    Attributes:
        http_server_options (Union[Unset, HTTPServerOptionsV4AaaGET]):
    ...
    http_server_options: Union[Unset, "HTTPServerOptionsV4AaaGET"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_http_server_options, Unset):
            ...
            http_server_options = HTTPServerOptionsV4AaaGET.from_dict(_http_server_options)
        ...
        gateway_configuration_spec_wrapper_v4_aaa_get = cls(
        ...
        gateway_configuration_spec_wrapper_v4_aaa_get.additional_properties = d
        return gateway_configuration_spec_wrapper_v4_aaa_get
