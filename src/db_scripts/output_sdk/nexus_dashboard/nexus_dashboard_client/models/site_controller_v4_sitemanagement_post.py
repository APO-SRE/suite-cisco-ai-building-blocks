...
T = TypeVar("T", bound="SiteControllerV4SitemanagementPOST")


@_attrs_define
class SiteControllerV4SitemanagementPOST:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_controller_v4_sitemanagement_post = cls(
            data_ip=data_ip,
            data_url=data_url,
        ...
        site_controller_v4_sitemanagement_post.additional_properties = d
        return site_controller_v4_sitemanagement_post
