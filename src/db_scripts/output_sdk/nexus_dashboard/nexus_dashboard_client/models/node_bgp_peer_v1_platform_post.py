...
T = TypeVar("T", bound="NodeBGPPeerV1PlatformPOST")


@_attrs_define
class NodeBGPPeerV1PlatformPOST:
    """Node bgp peer
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        node_bgp_peer_v1_platform_post = cls(
            as_=as_,
            ip=ip,
            ipv6=ipv6,
        )

        node_bgp_peer_v1_platform_post.additional_properties = d
        return node_bgp_peer_v1_platform_post
