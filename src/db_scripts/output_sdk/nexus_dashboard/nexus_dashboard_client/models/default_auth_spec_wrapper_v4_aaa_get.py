...
T = TypeVar("T", bound="DefaultAuthSpecWrapperV4AaaGET")


@_attrs_define
class DefaultAuthSpecWrapperV4AaaGET:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        default_auth_spec_wrapper_v4_aaa_get = cls(
            default_domain=default_domain,
            domain_name=domain_name,
        )

        default_auth_spec_wrapper_v4_aaa_get.additional_properties = d
        return default_auth_spec_wrapper_v4_aaa_get
