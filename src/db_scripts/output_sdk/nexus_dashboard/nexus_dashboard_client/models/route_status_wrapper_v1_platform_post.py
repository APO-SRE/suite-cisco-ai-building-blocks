...
T = TypeVar("T", bound="RouteStatusWrapperV1PlatformPOST")


@_attrs_define
class RouteStatusWrapperV1PlatformPOST:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        route_status_wrapper_v1_platform_post = cls(
            error=error,
        )

        route_status_wrapper_v1_platform_post.additional_properties = d
        return route_status_wrapper_v1_platform_post
