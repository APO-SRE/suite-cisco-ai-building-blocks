...
from ..models.tacacs_provider_v4_aaa_get_auth_protocol import TACACSProviderV4AaaGETAuthProtocol
from ..types import UNSET, Unset

T = TypeVar("T", bound="TACACSProviderV4AaaGET")


@_attrs_define
class TACACSProviderV4AaaGET:
    """
    Attributes:
        auth_protocol (Union[Unset, TACACSProviderV4AaaGETAuthProtocol]): TACACS provider server authentication
            mechanism
    ...
    auth_protocol: Union[Unset, TACACSProviderV4AaaGETAuthProtocol] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        auth_protocol: Union[Unset, TACACSProviderV4AaaGETAuthProtocol]
        if isinstance(_auth_protocol, Unset):
            auth_protocol = UNSET
        else:
            auth_protocol = TACACSProviderV4AaaGETAuthProtocol(_auth_protocol)
        ...
        tacacs_provider_v4_aaa_get = cls(
        ...
        tacacs_provider_v4_aaa_get.additional_properties = d
        return tacacs_provider_v4_aaa_get
