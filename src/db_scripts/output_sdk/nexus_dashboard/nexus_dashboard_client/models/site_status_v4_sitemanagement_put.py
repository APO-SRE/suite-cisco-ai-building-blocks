...
T = TypeVar("T", bound="SiteStatusV4SitemanagementPUT")


@_attrs_define
class SiteStatusV4SitemanagementPUT:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_status_v4_sitemanagement_put = cls(
            apps=apps,
        ...
        site_status_v4_sitemanagement_put.additional_properties = d
        return site_status_v4_sitemanagement_put
