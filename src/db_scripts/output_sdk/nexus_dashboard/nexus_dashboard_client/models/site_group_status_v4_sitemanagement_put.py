...
T = TypeVar("T", bound="SiteGroupStatusV4SitemanagementPUT")


@_attrs_define
class SiteGroupStatusV4SitemanagementPUT:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_group_status_v4_sitemanagement_put = cls(
            apps=apps,
            members=members,
        )

        site_group_status_v4_sitemanagement_put.additional_properties = d
        return site_group_status_v4_sitemanagement_put
