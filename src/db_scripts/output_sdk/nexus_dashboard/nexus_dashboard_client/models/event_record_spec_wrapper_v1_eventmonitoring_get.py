...
from ..models.event_record_spec_wrapper_v1_eventmonitoring_get_alert_state import (
    EventRecordSpecWrapperV1EventmonitoringGETAlertState,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="EventRecordSpecWrapperV1EventmonitoringGET")


@_attrs_define
class EventRecordSpecWrapperV1EventmonitoringGET:
    """
    Attributes:
        acked (Union[Unset, bool]): Tracks customer acknowledgment of the raised alert
        alert_state (Union[Unset, EventRecordSpecWrapperV1EventmonitoringGETAlertState]): Tracks the last observed state
    ...
    alert_state: Union[Unset, EventRecordSpecWrapperV1EventmonitoringGETAlertState] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        alert_state: Union[Unset, EventRecordSpecWrapperV1EventmonitoringGETAlertState]
        if isinstance(_alert_state, Unset):
            alert_state = UNSET
        else:
            alert_state = EventRecordSpecWrapperV1EventmonitoringGETAlertState(_alert_state)

        meta_name = d.pop("metaName", UNSET)

        record_id = d.pop("recordId", UNSET)

        event_record_spec_wrapper_v1_eventmonitoring_get = cls(
            acked=acked,
        ...
        event_record_spec_wrapper_v1_eventmonitoring_get.additional_properties = d
        return event_record_spec_wrapper_v1_eventmonitoring_get
