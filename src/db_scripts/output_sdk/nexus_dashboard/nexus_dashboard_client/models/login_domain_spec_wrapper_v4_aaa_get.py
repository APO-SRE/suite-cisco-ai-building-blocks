...
from ..models.login_domain_spec_wrapper_v4_aaa_get_realm import LoginDomainSpecWrapperV4AaaGETRealm
...
T = TypeVar("T", bound="LoginDomainSpecWrapperV4AaaGET")


@_attrs_define
class LoginDomainSpecWrapperV4AaaGET:
    """
    Attributes:
        description (Union[Unset, str]): Description about the login domain
        domain (Union[Unset, str]): Login domain name
        realm (Union[Unset, LoginDomainSpecWrapperV4AaaGETRealm]): Login domain realm type
    ...
    realm: Union[Unset, LoginDomainSpecWrapperV4AaaGETRealm] = UNSET
    servers: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        realm: Union[Unset, LoginDomainSpecWrapperV4AaaGETRealm]
        if isinstance(_realm, Unset):
            realm = UNSET
        else:
            realm = LoginDomainSpecWrapperV4AaaGETRealm(_realm)
        ...
        login_domain_spec_wrapper_v4_aaa_get = cls(
        ...
        login_domain_spec_wrapper_v4_aaa_get.additional_properties = d
        return login_domain_spec_wrapper_v4_aaa_get
