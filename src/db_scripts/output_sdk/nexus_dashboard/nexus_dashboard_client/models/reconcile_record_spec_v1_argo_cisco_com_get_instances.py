...
T = TypeVar("T", bound="ReconcileRecordSpecV1ArgoCiscoComGETInstances")


@_attrs_define
class ReconcileRecordSpecV1ArgoCiscoComGETInstances:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        reconcile_record_spec_v1_argo_cisco_com_get_instances = cls()
        ...
        reconcile_record_spec_v1_argo_cisco_com_get_instances.additional_properties = additional_properties
        return reconcile_record_spec_v1_argo_cisco_com_get_instances
