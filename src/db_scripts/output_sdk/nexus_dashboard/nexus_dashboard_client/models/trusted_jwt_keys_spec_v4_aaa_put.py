...
T = TypeVar("T", bound="TrustedJWTKeysSpecV4AaaPUT")


@_attrs_define
class TrustedJWTKeysSpecV4AaaPUT:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        trusted_jwt_keys_spec_v4_aaa_put = cls(
            key_id=key_id,
            public_key=public_key,
            remote_id_claim=remote_id_claim,
        )

        trusted_jwt_keys_spec_v4_aaa_put.additional_properties = d
        return trusted_jwt_keys_spec_v4_aaa_put
