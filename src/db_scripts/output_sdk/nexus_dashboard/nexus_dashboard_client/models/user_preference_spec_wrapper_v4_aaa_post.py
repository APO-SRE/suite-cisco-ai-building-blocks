...
if TYPE_CHECKING:
    from ..models.user_preference_spec_wrapper_v4_aaa_post_custom_preferences import (
        UserPreferenceSpecWrapperV4AaaPOSTCustomPreferences,
    )
    from ..models.user_preference_spec_wrapper_v4_aaa_post_displayed_app_instances import (
        UserPreferenceSpecWrapperV4AaaPOSTDisplayedAppInstances,
    )


T = TypeVar("T", bound="UserPreferenceSpecWrapperV4AaaPOST")


@_attrs_define
class UserPreferenceSpecWrapperV4AaaPOST:
    """
    Attributes:
        login_id (str): User login ID
        custom_preferences (Union[Unset, UserPreferenceSpecWrapperV4AaaPOSTCustomPreferences]): Custom user preferences
            fields
        displayed_app_instances (Union[Unset, UserPreferenceSpecWrapperV4AaaPOSTDisplayedAppInstances]): Application
    ...
    login_id: str
    custom_preferences: Union[Unset, "UserPreferenceSpecWrapperV4AaaPOSTCustomPreferences"] = UNSET
    displayed_app_instances: Union[Unset, "UserPreferenceSpecWrapperV4AaaPOSTDisplayedAppInstances"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_preferences: Union[Unset, UserPreferenceSpecWrapperV4AaaPOSTCustomPreferences]
        if isinstance(_custom_preferences, Unset):
            custom_preferences = UNSET
        else:
            custom_preferences = UserPreferenceSpecWrapperV4AaaPOSTCustomPreferences.from_dict(_custom_preferences)

        _displayed_app_instances = d.pop("displayedAppInstances", UNSET)
        displayed_app_instances: Union[Unset, UserPreferenceSpecWrapperV4AaaPOSTDisplayedAppInstances]
        if isinstance(_displayed_app_instances, Unset):
            displayed_app_instances = UNSET
        else:
            displayed_app_instances = UserPreferenceSpecWrapperV4AaaPOSTDisplayedAppInstances.from_dict(
        ...
        user_preference_spec_wrapper_v4_aaa_post = cls(
            login_id=login_id,
        ...
        user_preference_spec_wrapper_v4_aaa_post.additional_properties = d
        return user_preference_spec_wrapper_v4_aaa_post
