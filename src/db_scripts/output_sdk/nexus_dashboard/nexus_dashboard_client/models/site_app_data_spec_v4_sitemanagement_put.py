...
if TYPE_CHECKING:
    from ..models.site_app_data_spec_v4_sitemanagement_put_site_annotation import (
        SiteAppDataSpecV4SitemanagementPUTSiteAnnotation,
    )
    from ..models.site_app_data_spec_v4_sitemanagement_put_site_annotation_lock import (
        SiteAppDataSpecV4SitemanagementPUTSiteAnnotationLock,
    )


T = TypeVar("T", bound="SiteAppDataSpecV4SitemanagementPUT")


@_attrs_define
class SiteAppDataSpecV4SitemanagementPUT:
    """
    Attributes:
        apps (Union[Unset, list[str]]):
        site_annotation (Union[Unset, SiteAppDataSpecV4SitemanagementPUTSiteAnnotation]):
        site_annotation_lock (Union[Unset, SiteAppDataSpecV4SitemanagementPUTSiteAnnotationLock]):
        site_uuid (Union[Unset, str]):
    """

    apps: Union[Unset, list[str]] = UNSET
    site_annotation: Union[Unset, "SiteAppDataSpecV4SitemanagementPUTSiteAnnotation"] = UNSET
    site_annotation_lock: Union[Unset, "SiteAppDataSpecV4SitemanagementPUTSiteAnnotationLock"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_site_annotation, Unset):
            ...
            site_annotation = SiteAppDataSpecV4SitemanagementPUTSiteAnnotation.from_dict(_site_annotation)
        ...
        if isinstance(_site_annotation_lock, Unset):
            ...
            site_annotation_lock = SiteAppDataSpecV4SitemanagementPUTSiteAnnotationLock.from_dict(_site_annotation_lock)

        site_uuid = d.pop("siteUUID", UNSET)

        site_app_data_spec_v4_sitemanagement_put = cls(
            apps=apps,
        ...
        site_app_data_spec_v4_sitemanagement_put.additional_properties = d
        return site_app_data_spec_v4_sitemanagement_put
