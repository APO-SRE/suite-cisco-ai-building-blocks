...
T = TypeVar("T", bound="ClusterSpecNTPServerV2PlatformPUT")


@_attrs_define
class ClusterSpecNTPServerV2PlatformPUT:
    """Cluster NTP Server
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cluster_spec_ntp_server_v2_platform_put = cls(
            host=host,
            key_id=key_id,
            prefer=prefer,
        )

        cluster_spec_ntp_server_v2_platform_put.additional_properties = d
        return cluster_spec_ntp_server_v2_platform_put
