...
T = TypeVar("T", bound="DCNMFabricResponseV4SitemanagementGET")


@_attrs_define
class DCNMFabricResponseV4SitemanagementGET:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dcnm_fabric_response_v4_sitemanagement_get = cls(
            in_use=in_use,
            name=name,
        ...
        dcnm_fabric_response_v4_sitemanagement_get.additional_properties = d
        return dcnm_fabric_response_v4_sitemanagement_get
