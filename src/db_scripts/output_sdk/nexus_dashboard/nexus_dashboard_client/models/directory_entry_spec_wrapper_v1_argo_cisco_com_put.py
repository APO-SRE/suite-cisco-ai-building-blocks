...
T = TypeVar("T", bound="DirectoryEntrySpecWrapperV1ArgoCiscoComPUT")


@_attrs_define
class DirectoryEntrySpecWrapperV1ArgoCiscoComPUT:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        directory_entry_spec_wrapper_v1_argo_cisco_com_put = cls(
        ...
        directory_entry_spec_wrapper_v1_argo_cisco_com_put.additional_properties = d
        return directory_entry_spec_wrapper_v1_argo_cisco_com_put
