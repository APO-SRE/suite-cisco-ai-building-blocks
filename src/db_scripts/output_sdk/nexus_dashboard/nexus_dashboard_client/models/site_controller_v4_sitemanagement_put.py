...
T = TypeVar("T", bound="SiteControllerV4SitemanagementPUT")


@_attrs_define
class SiteControllerV4SitemanagementPUT:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_controller_v4_sitemanagement_put = cls(
            data_ip=data_ip,
            data_url=data_url,
        ...
        site_controller_v4_sitemanagement_put.additional_properties = d
        return site_controller_v4_sitemanagement_put
