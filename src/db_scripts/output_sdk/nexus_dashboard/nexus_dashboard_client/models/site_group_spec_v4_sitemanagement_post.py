...
T = TypeVar("T", bound="SiteGroupSpecV4SitemanagementPOST")


@_attrs_define
class SiteGroupSpecV4SitemanagementPOST:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_group_spec_v4_sitemanagement_post = cls(
        ...
        site_group_spec_v4_sitemanagement_post.additional_properties = d
        return site_group_spec_v4_sitemanagement_post
