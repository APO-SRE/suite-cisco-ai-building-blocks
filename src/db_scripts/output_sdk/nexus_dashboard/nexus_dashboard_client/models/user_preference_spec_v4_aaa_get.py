...
if TYPE_CHECKING:
    from ..models.user_preference_spec_v4_aaa_get_custom_preferences import UserPreferenceSpecV4AaaGETCustomPreferences
    from ..models.user_preference_spec_v4_aaa_get_displayed_app_instances import (
        UserPreferenceSpecV4AaaGETDisplayedAppInstances,
    )


T = TypeVar("T", bound="UserPreferenceSpecV4AaaGET")


@_attrs_define
class UserPreferenceSpecV4AaaGET:
    """
    Attributes:
        custom_preferences (Union[Unset, UserPreferenceSpecV4AaaGETCustomPreferences]): Custom user preferences fields
        displayed_app_instances (Union[Unset, UserPreferenceSpecV4AaaGETDisplayedAppInstances]): Application instances
    ...
    custom_preferences: Union[Unset, "UserPreferenceSpecV4AaaGETCustomPreferences"] = UNSET
    displayed_app_instances: Union[Unset, "UserPreferenceSpecV4AaaGETDisplayedAppInstances"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.user_preference_spec_v4_aaa_get_custom_preferences import (
        ...
        custom_preferences: Union[Unset, UserPreferenceSpecV4AaaGETCustomPreferences]
        if isinstance(_custom_preferences, Unset):
            custom_preferences = UNSET
        else:
            custom_preferences = UserPreferenceSpecV4AaaGETCustomPreferences.from_dict(_custom_preferences)

        _displayed_app_instances = d.pop("displayedAppInstances", UNSET)
        displayed_app_instances: Union[Unset, UserPreferenceSpecV4AaaGETDisplayedAppInstances]
        if isinstance(_displayed_app_instances, Unset):
            displayed_app_instances = UNSET
        else:
            displayed_app_instances = UserPreferenceSpecV4AaaGETDisplayedAppInstances.from_dict(
        ...
        user_preference_spec_v4_aaa_get = cls(
        ...
        user_preference_spec_v4_aaa_get.additional_properties = d
        return user_preference_spec_v4_aaa_get
