...
T = TypeVar("T", bound="SiteFederationInfoV4SitemanagementGET")


@_attrs_define
class SiteFederationInfoV4SitemanagementGET:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_federation_info_v4_sitemanagement_get = cls(
        ...
        site_federation_info_v4_sitemanagement_get.additional_properties = d
        return site_federation_info_v4_sitemanagement_get
