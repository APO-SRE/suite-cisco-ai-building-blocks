...
from ..models.cluster_spec_wrapper_v2_platform_put_network_mode import ClusterSpecWrapperV2PlatformPUTNetworkMode
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.cluster_spec_network_v1_platform_put import ClusterSpecNetworkV1PlatformPUT
    from ..models.cluster_spec_ntp_config_v2_platform_put import ClusterSpecNTPConfigV2PlatformPUT
    from ..models.cluster_spec_proxy_config_v1_platform_put import ClusterSpecProxyConfigV1PlatformPUT


T = TypeVar("T", bound="ClusterSpecWrapperV2PlatformPUT")


@_attrs_define
class ClusterSpecWrapperV2PlatformPUT:
    """
    Attributes:
        ...
        network_mode (Union[Unset, ClusterSpecWrapperV2PlatformPUTNetworkMode]): Shows what IP protocols are configured
            on this cluster
        ntp_config (Union[Unset, ClusterSpecNTPConfigV2PlatformPUT]): Cluster NTP config
    ...
    network_mode: Union[Unset, ClusterSpecWrapperV2PlatformPUTNetworkMode] = UNSET
    ntp_config: Union[Unset, "ClusterSpecNTPConfigV2PlatformPUT"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        network_mode: Union[Unset, ClusterSpecWrapperV2PlatformPUTNetworkMode]
        if isinstance(_network_mode, Unset):
            network_mode = UNSET
        else:
            network_mode = ClusterSpecWrapperV2PlatformPUTNetworkMode(_network_mode)

        _ntp_config = d.pop("ntpConfig", UNSET)
        ntp_config: Union[Unset, ClusterSpecNTPConfigV2PlatformPUT]
        if isinstance(_ntp_config, Unset):
            ntp_config = UNSET
        else:
            ntp_config = ClusterSpecNTPConfigV2PlatformPUT.from_dict(_ntp_config)
        ...
        cluster_spec_wrapper_v2_platform_put = cls(
        ...
        cluster_spec_wrapper_v2_platform_put.additional_properties = d
        return cluster_spec_wrapper_v2_platform_put
