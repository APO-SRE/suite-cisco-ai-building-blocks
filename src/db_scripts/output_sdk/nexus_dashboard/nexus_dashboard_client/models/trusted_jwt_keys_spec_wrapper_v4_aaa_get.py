...
T = TypeVar("T", bound="TrustedJWTKeysSpecWrapperV4AaaGET")


@_attrs_define
class TrustedJWTKeysSpecWrapperV4AaaGET:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        trusted_jwt_keys_spec_wrapper_v4_aaa_get = cls(
            app_name=app_name,
            key_id=key_id,
        ...
        trusted_jwt_keys_spec_wrapper_v4_aaa_get.additional_properties = d
        return trusted_jwt_keys_spec_wrapper_v4_aaa_get
