...
from ..models.event_occurrence_v1_eventmonitoring_put_severity import EventOccurrenceV1EventmonitoringPUTSeverity
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.record_stream_v1_eventmonitoring_put import RecordStreamV1EventmonitoringPUT


T = TypeVar("T", bound="EventOccurrenceV1EventmonitoringPUT")


@_attrs_define
class EventOccurrenceV1EventmonitoringPUT:
    ...
    Attributes:
        ...
        result_value (Union[Unset, str]): Current result value of the resource being monitored as part of event
            configuration
        severity (Union[Unset, EventOccurrenceV1EventmonitoringPUTSeverity]): Severity of the event configuration being
            monitored with respect to the threshold
        stream_history (Union[Unset, list['RecordStreamV1EventmonitoringPUT']]): List of streams where event record
    ...
    severity: Union[Unset, EventOccurrenceV1EventmonitoringPUTSeverity] = UNSET
    stream_history: Union[Unset, list["RecordStreamV1EventmonitoringPUT"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        severity: Union[Unset, EventOccurrenceV1EventmonitoringPUTSeverity]
        if isinstance(_severity, Unset):
            severity = UNSET
        else:
            severity = EventOccurrenceV1EventmonitoringPUTSeverity(_severity)

        stream_history = []
        _stream_history = d.pop("streamHistory", UNSET)
        for stream_history_item_data in _stream_history or []:
            stream_history_item = RecordStreamV1EventmonitoringPUT.from_dict(stream_history_item_data)

            stream_history.append(stream_history_item)

        event_occurrence_v1_eventmonitoring_put = cls(
        ...
        event_occurrence_v1_eventmonitoring_put.additional_properties = d
        return event_occurrence_v1_eventmonitoring_put
