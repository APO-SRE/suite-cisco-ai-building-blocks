...
T = TypeVar("T", bound="ACIConfigV4SitemanagementPUT")


@_attrs_define
class ACIConfigV4SitemanagementPUT:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        aci_config_v4_sitemanagement_put = cls(
            inband_epgdn=inband_epgdn,
        )

        aci_config_v4_sitemanagement_put.additional_properties = d
        return aci_config_v4_sitemanagement_put
