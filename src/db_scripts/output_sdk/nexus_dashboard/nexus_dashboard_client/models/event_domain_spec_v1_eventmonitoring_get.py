...
T = TypeVar("T", bound="EventDomainSpecV1EventmonitoringGET")


@_attrs_define
class EventDomainSpecV1EventmonitoringGET:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        event_domain_spec_v1_eventmonitoring_get = cls(
            event_configs=event_configs,
            meta_name=meta_name,
        )

        event_domain_spec_v1_eventmonitoring_get.additional_properties = d
        return event_domain_spec_v1_eventmonitoring_get
