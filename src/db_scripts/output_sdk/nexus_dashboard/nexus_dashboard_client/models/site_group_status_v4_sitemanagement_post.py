...
T = TypeVar("T", bound="SiteGroupStatusV4SitemanagementPOST")


@_attrs_define
class SiteGroupStatusV4SitemanagementPOST:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_group_status_v4_sitemanagement_post = cls(
            apps=apps,
            members=members,
        )

        site_group_status_v4_sitemanagement_post.additional_properties = d
        return site_group_status_v4_sitemanagement_post
