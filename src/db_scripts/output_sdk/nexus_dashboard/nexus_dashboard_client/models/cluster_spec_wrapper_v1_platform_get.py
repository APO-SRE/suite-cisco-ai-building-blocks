...
from ..models.cluster_spec_wrapper_v1_platform_get_network_mode import ClusterSpecWrapperV1PlatformGETNetworkMode
...
T = TypeVar("T", bound="ClusterSpecWrapperV1PlatformGET")


@_attrs_define
class ClusterSpecWrapperV1PlatformGET:
    """
    Attributes:
        ...
        network_mode (Union[Unset, ClusterSpecWrapperV1PlatformGETNetworkMode]): Shows what IP protocols are configured
            on this cluster
    ...
    network_mode: Union[Unset, ClusterSpecWrapperV1PlatformGETNetworkMode] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        network_mode: Union[Unset, ClusterSpecWrapperV1PlatformGETNetworkMode]
        if isinstance(_network_mode, Unset):
            network_mode = UNSET
        else:
            network_mode = ClusterSpecWrapperV1PlatformGETNetworkMode(_network_mode)
        ...
        cluster_spec_wrapper_v1_platform_get = cls(
        ...
        cluster_spec_wrapper_v1_platform_get.additional_properties = d
        return cluster_spec_wrapper_v1_platform_get
