...
T = TypeVar("T", bound="SiteAppDataSpecWrapperV4SitemanagementPUTSiteAnnotationLock")


@_attrs_define
class SiteAppDataSpecWrapperV4SitemanagementPUTSiteAnnotationLock:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        site_app_data_spec_wrapper_v4_sitemanagement_put_site_annotation_lock = cls()
        ...
        site_app_data_spec_wrapper_v4_sitemanagement_put_site_annotation_lock.additional_properties = (
            additional_properties
        )
        return site_app_data_spec_wrapper_v4_sitemanagement_put_site_annotation_lock
