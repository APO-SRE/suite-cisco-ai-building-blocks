...
from ..models.event_occurrence_v1_eventmonitoring_get_severity import EventOccurrenceV1EventmonitoringGETSeverity
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.record_stream_v1_eventmonitoring_get import RecordStreamV1EventmonitoringGET


T = TypeVar("T", bound="EventOccurrenceV1EventmonitoringGET")


@_attrs_define
class EventOccurrenceV1EventmonitoringGET:
    ...
    Attributes:
        ...
        result_value (Union[Unset, str]): Current result value of the resource being monitored as part of event
            configuration
        severity (Union[Unset, EventOccurrenceV1EventmonitoringGETSeverity]): Severity of the event configuration being
            monitored with respect to the threshold
        stream_history (Union[Unset, list['RecordStreamV1EventmonitoringGET']]): List of streams where event record
    ...
    severity: Union[Unset, EventOccurrenceV1EventmonitoringGETSeverity] = UNSET
    stream_history: Union[Unset, list["RecordStreamV1EventmonitoringGET"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        severity: Union[Unset, EventOccurrenceV1EventmonitoringGETSeverity]
        if isinstance(_severity, Unset):
            severity = UNSET
        else:
            severity = EventOccurrenceV1EventmonitoringGETSeverity(_severity)

        stream_history = []
        _stream_history = d.pop("streamHistory", UNSET)
        for stream_history_item_data in _stream_history or []:
            stream_history_item = RecordStreamV1EventmonitoringGET.from_dict(stream_history_item_data)

            stream_history.append(stream_history_item)

        event_occurrence_v1_eventmonitoring_get = cls(
        ...
        event_occurrence_v1_eventmonitoring_get.additional_properties = d
        return event_occurrence_v1_eventmonitoring_get
