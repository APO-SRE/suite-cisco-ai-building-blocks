...
from ..models.radius_provider_v4_aaa_post_auth_protocol import RADIUSProviderV4AaaPOSTAuthProtocol
from ..types import UNSET, Unset

T = TypeVar("T", bound="RADIUSProviderV4AaaPOST")


@_attrs_define
class RADIUSProviderV4AaaPOST:
    """
    Attributes:
        auth_protocol (Union[Unset, RADIUSProviderV4AaaPOSTAuthProtocol]): RADIUS provider server authentication
            mechanism
    ...
    auth_protocol: Union[Unset, RADIUSProviderV4AaaPOSTAuthProtocol] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        auth_protocol: Union[Unset, RADIUSProviderV4AaaPOSTAuthProtocol]
        if isinstance(_auth_protocol, Unset):
            auth_protocol = UNSET
        else:
            auth_protocol = RADIUSProviderV4AaaPOSTAuthProtocol(_auth_protocol)
        ...
        radius_provider_v4_aaa_post = cls(
        ...
        radius_provider_v4_aaa_post.additional_properties = d
        return radius_provider_v4_aaa_post
