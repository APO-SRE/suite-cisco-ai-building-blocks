...
from ..models.node_spec_v1_platform_post_role import NodeSpecV1PlatformPOSTRole
...
T = TypeVar("T", bound="NodeSpecV1PlatformPOST")


@_attrs_define
class NodeSpecV1PlatformPOST:
    """Node configuration
    ...
    Attributes:
        ...
        role (Union[Unset, NodeSpecV1PlatformPOSTRole]): Node role
    ...
    role: Union[Unset, NodeSpecV1PlatformPOSTRole] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        role: Union[Unset, NodeSpecV1PlatformPOSTRole]
        if isinstance(_role, Unset):
            role = UNSET
        else:
            role = NodeSpecV1PlatformPOSTRole(_role)

        serial_number = d.pop("serialNumber", UNSET)

        node_spec_v1_platform_post = cls(
        ...
        node_spec_v1_platform_post.additional_properties = d
        return node_spec_v1_platform_post
