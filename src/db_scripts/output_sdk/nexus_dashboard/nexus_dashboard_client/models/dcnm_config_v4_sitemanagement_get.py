...
T = TypeVar("T", bound="DCNMConfigV4SitemanagementGET")


@_attrs_define
class DCNMConfigV4SitemanagementGET:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dcnm_config_v4_sitemanagement_get = cls(
            fabric_name=fabric_name,
            fabric_technology=fabric_technology,
            fabric_type=fabric_type,
        )

        dcnm_config_v4_sitemanagement_get.additional_properties = d
        return dcnm_config_v4_sitemanagement_get
