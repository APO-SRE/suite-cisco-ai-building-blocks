...
from ..models.cluster_status_wrapper_v2_platform_get_state import ClusterStatusWrapperV2PlatformGETState
...
T = TypeVar("T", bound="ClusterStatusWrapperV2PlatformGET")


@_attrs_define
class ClusterStatusWrapperV2PlatformGET:
    """
    Attributes:
        ...
        state (Union[Unset, ClusterStatusWrapperV2PlatformGETState]): State of dual-stack mode in cluster
    ...
    state: Union[Unset, ClusterStatusWrapperV2PlatformGETState] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        state: Union[Unset, ClusterStatusWrapperV2PlatformGETState]
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = ClusterStatusWrapperV2PlatformGETState(_state)

        target_version = d.pop("targetVersion", UNSET)

        uuid = d.pop("uuid", UNSET)

        cluster_status_wrapper_v2_platform_get = cls(
        ...
        cluster_status_wrapper_v2_platform_get.additional_properties = d
        return cluster_status_wrapper_v2_platform_get
