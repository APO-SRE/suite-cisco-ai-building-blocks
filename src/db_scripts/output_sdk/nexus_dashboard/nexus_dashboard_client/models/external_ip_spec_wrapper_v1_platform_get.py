...
T = TypeVar("T", bound="ExternalIpSpecWrapperV1PlatformGET")


@_attrs_define
class ExternalIpSpecWrapperV1PlatformGET:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        external_ip_spec_wrapper_v1_platform_get = cls(
            ip=ip,
            name=name,
            target_network=target_network,
        )

        external_ip_spec_wrapper_v1_platform_get.additional_properties = d
        return external_ip_spec_wrapper_v1_platform_get
