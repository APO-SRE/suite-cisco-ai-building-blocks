...
from ..models.member_status_v4_federation_get_reachability import MemberStatusV4FederationGETReachability
...
T = TypeVar("T", bound="MemberStatusV4FederationGET")


@_attrs_define
class MemberStatusV4FederationGET:
    """
    Attributes:
        ...
        reachability (Union[Unset, MemberStatusV4FederationGETReachability]): Member reachability status -
            Unknown/Up/Down
    """
    ...
    reachability: Union[Unset, MemberStatusV4FederationGETReachability] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reachability: Union[Unset, MemberStatusV4FederationGETReachability]
        if isinstance(_reachability, Unset):
            reachability = UNSET
        else:
            reachability = MemberStatusV4FederationGETReachability(_reachability)

        member_status_v4_federation_get = cls(
        ...
        member_status_v4_federation_get.additional_properties = d
        return member_status_v4_federation_get
