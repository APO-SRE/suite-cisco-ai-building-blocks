...
T = TypeVar("T", bound="GatewayConfigurationSpecWrapperV4AaaPUT")


@_attrs_define
class GatewayConfigurationSpecWrapperV4AaaPUT:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gateway_configuration_spec_wrapper_v4_aaa_put = cls(
        ...
        gateway_configuration_spec_wrapper_v4_aaa_put.additional_properties = d
        return gateway_configuration_spec_wrapper_v4_aaa_put
