...
from ..models.tacacs_provider_v4_aaa_post_auth_protocol import TACACSProviderV4AaaPOSTAuthProtocol
from ..types import UNSET, Unset

T = TypeVar("T", bound="TACACSProviderV4AaaPOST")


@_attrs_define
class TACACSProviderV4AaaPOST:
    """
    Attributes:
        auth_protocol (Union[Unset, TACACSProviderV4AaaPOSTAuthProtocol]): TACACS provider server authentication
            mechanism
    ...
    auth_protocol: Union[Unset, TACACSProviderV4AaaPOSTAuthProtocol] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        auth_protocol: Union[Unset, TACACSProviderV4AaaPOSTAuthProtocol]
        if isinstance(_auth_protocol, Unset):
            auth_protocol = UNSET
        else:
            auth_protocol = TACACSProviderV4AaaPOSTAuthProtocol(_auth_protocol)
        ...
        tacacs_provider_v4_aaa_post = cls(
        ...
        tacacs_provider_v4_aaa_post.additional_properties = d
        return tacacs_provider_v4_aaa_post
