...
from ..models.node_status_v1_platform_post_machine_type import NodeStatusV1PlatformPOSTMachineType
from ..models.node_status_v1_platform_post_platform_type import NodeStatusV1PlatformPOSTPlatformType
from ..models.node_status_v1_platform_post_state import NodeStatusV1PlatformPOSTState
...
T = TypeVar("T", bound="NodeStatusV1PlatformPOST")


@_attrs_define
class NodeStatusV1PlatformPOST:
    ...
    Attributes:
        ...
        machine_type (Union[Unset, NodeStatusV1PlatformPOSTMachineType]): Node hardware type
        model (Union[Unset, str]): Node model
        platform_type (Union[Unset, NodeStatusV1PlatformPOSTPlatformType]): Node platform type
        serf_status (Union[Unset, str]): Node's Serf status
        state (Union[Unset, NodeStatusV1PlatformPOSTState]): Node operational Status
    ...
    machine_type: Union[Unset, NodeStatusV1PlatformPOSTMachineType] = UNSET
    model: Union[Unset, str] = UNSET
    platform_type: Union[Unset, NodeStatusV1PlatformPOSTPlatformType] = UNSET
    serf_status: Union[Unset, str] = UNSET
    state: Union[Unset, NodeStatusV1PlatformPOSTState] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        machine_type: Union[Unset, NodeStatusV1PlatformPOSTMachineType]
        if isinstance(_machine_type, Unset):
            machine_type = UNSET
        else:
            machine_type = NodeStatusV1PlatformPOSTMachineType(_machine_type)

        model = d.pop("model", UNSET)

        _platform_type = d.pop("platformType", UNSET)
        platform_type: Union[Unset, NodeStatusV1PlatformPOSTPlatformType]
        if isinstance(_platform_type, Unset):
            platform_type = UNSET
        else:
            platform_type = NodeStatusV1PlatformPOSTPlatformType(_platform_type)

        serf_status = d.pop("serfStatus", UNSET)

        _state = d.pop("state", UNSET)
        state: Union[Unset, NodeStatusV1PlatformPOSTState]
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = NodeStatusV1PlatformPOSTState(_state)

        uuid = d.pop("uuid", UNSET)

        version = d.pop("version", UNSET)

        node_status_v1_platform_post = cls(
            boot_time=boot_time,
        ...
        node_status_v1_platform_post.additional_properties = d
        return node_status_v1_platform_post
