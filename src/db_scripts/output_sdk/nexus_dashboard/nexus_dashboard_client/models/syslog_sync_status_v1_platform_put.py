...
T = TypeVar("T", bound="SyslogSyncStatusV1PlatformPUT")


@_attrs_define
class SyslogSyncStatusV1PlatformPUT:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        syslog_sync_status_v1_platform_put = cls(
            error=error,
        )

        syslog_sync_status_v1_platform_put.additional_properties = d
        return syslog_sync_status_v1_platform_put
