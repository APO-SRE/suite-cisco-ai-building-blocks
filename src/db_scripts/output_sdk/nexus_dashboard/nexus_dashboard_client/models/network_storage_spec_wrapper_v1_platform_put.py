...
from ..models.network_storage_spec_wrapper_v1_platform_put_access_mode import (
    NetworkStorageSpecWrapperV1PlatformPUTAccessMode,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="NetworkStorageSpecWrapperV1PlatformPUT")


@_attrs_define
class NetworkStorageSpecWrapperV1PlatformPUT:
    """
    Attributes:
        access_mode (Union[Unset, NetworkStorageSpecWrapperV1PlatformPUTAccessMode]): Allowed accessmode of storage
    ...
    access_mode: Union[Unset, NetworkStorageSpecWrapperV1PlatformPUTAccessMode] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        access_mode: Union[Unset, NetworkStorageSpecWrapperV1PlatformPUTAccessMode]
        if isinstance(_access_mode, Unset):
            access_mode = UNSET
        else:
            access_mode = NetworkStorageSpecWrapperV1PlatformPUTAccessMode(_access_mode)
        ...
        network_storage_spec_wrapper_v1_platform_put = cls(
        ...
        network_storage_spec_wrapper_v1_platform_put.additional_properties = d
        return network_storage_spec_wrapper_v1_platform_put
