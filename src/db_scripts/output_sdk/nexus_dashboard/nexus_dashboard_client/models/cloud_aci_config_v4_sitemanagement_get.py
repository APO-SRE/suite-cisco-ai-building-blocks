...
T = TypeVar("T", bound="CloudACIConfigV4SitemanagementGET")


@_attrs_define
class CloudACIConfigV4SitemanagementGET:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cloud_aci_config_v4_sitemanagement_get = cls(
            inband_epgdn=inband_epgdn,
        )

        cloud_aci_config_v4_sitemanagement_get.additional_properties = d
        return cloud_aci_config_v4_sitemanagement_get
