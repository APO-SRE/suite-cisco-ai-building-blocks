...
T = TypeVar("T", bound="UserPreferenceSpecWrapperV4AaaGETDisplayedAppInstances")


@_attrs_define
class UserPreferenceSpecWrapperV4AaaGETDisplayedAppInstances:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        user_preference_spec_wrapper_v4_aaa_get_displayed_app_instances = cls()
        ...
        user_preference_spec_wrapper_v4_aaa_get_displayed_app_instances.additional_properties = additional_properties
        return user_preference_spec_wrapper_v4_aaa_get_displayed_app_instances
