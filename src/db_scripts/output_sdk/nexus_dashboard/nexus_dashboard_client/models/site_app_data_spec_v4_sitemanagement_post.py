...
if TYPE_CHECKING:
    from ..models.site_app_data_spec_v4_sitemanagement_post_site_annotation import (
        SiteAppDataSpecV4SitemanagementPOSTSiteAnnotation,
    )
    from ..models.site_app_data_spec_v4_sitemanagement_post_site_annotation_lock import (
        SiteAppDataSpecV4SitemanagementPOSTSiteAnnotationLock,
    )


T = TypeVar("T", bound="SiteAppDataSpecV4SitemanagementPOST")


@_attrs_define
class SiteAppDataSpecV4SitemanagementPOST:
    """
    Attributes:
        apps (Union[Unset, list[str]]):
        site_annotation (Union[Unset, SiteAppDataSpecV4SitemanagementPOSTSiteAnnotation]):
        site_annotation_lock (Union[Unset, SiteAppDataSpecV4SitemanagementPOSTSiteAnnotationLock]):
        site_uuid (Union[Unset, str]):
    """

    apps: Union[Unset, list[str]] = UNSET
    site_annotation: Union[Unset, "SiteAppDataSpecV4SitemanagementPOSTSiteAnnotation"] = UNSET
    site_annotation_lock: Union[Unset, "SiteAppDataSpecV4SitemanagementPOSTSiteAnnotationLock"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_site_annotation, Unset):
            ...
            site_annotation = SiteAppDataSpecV4SitemanagementPOSTSiteAnnotation.from_dict(_site_annotation)
        ...
        if isinstance(_site_annotation_lock, Unset):
            ...
            site_annotation_lock = SiteAppDataSpecV4SitemanagementPOSTSiteAnnotationLock.from_dict(
                _site_annotation_lock
            )

        site_uuid = d.pop("siteUUID", UNSET)

        site_app_data_spec_v4_sitemanagement_post = cls(
            apps=apps,
        ...
        site_app_data_spec_v4_sitemanagement_post.additional_properties = d
        return site_app_data_spec_v4_sitemanagement_post
