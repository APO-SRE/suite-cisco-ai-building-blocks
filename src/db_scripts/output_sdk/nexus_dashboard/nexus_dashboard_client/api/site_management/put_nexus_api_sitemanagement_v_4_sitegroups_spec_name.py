...
from ...models.site_group_v4_sitemanagement_put import SiteGroupV4SitemanagementPUT
...
def _get_kwargs(
    spec_name: str,
    *,
    body: SiteGroupV4SitemanagementPUT,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/nexus/api/sitemanagement/v4/sitegroups/{spec_name}",
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = SiteGroupV4SitemanagementGET.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Modify an existing object of type SiteGroup
