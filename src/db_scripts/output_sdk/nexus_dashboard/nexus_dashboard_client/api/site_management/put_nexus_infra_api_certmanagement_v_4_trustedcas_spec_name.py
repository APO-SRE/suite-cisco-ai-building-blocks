...
from ...models.trusted_cav4_certmanagement_put import TrustedCAV4CertmanagementPUT
...
def _get_kwargs(
    spec_name: str,
    *,
    body: TrustedCAV4CertmanagementPUT,
...
def sync_detailed(
    ...
    *,
    ...
    """Modify an existing object of type TrustedCA
