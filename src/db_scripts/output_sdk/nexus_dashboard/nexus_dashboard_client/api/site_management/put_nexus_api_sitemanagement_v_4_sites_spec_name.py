...
from ...models.site_v4_sitemanagement_put import SiteV4SitemanagementPUT
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = SiteV4SitemanagementGET.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Modify a site
     ...
     Modify a resource of type  Site

    Args:
        spec_name (str):
        auth_cookie (Union[Unset, str]):
        cookie (Union[Unset, str]):
        body (SiteV4SitemanagementPUT): Site Resource
