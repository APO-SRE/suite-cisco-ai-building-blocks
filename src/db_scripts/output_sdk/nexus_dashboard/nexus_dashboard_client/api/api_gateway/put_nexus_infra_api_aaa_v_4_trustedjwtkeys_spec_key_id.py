...
from ...models.trusted_jwt_keys_v4_aaa_put import TrustedJWTKeysV4AaaPUT
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = TrustedJWTKeysV4AaaGET.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Modify a trusted JWT key
     ...
     Modify a resource of type TrustedJWTKeys
    ...
    Args:
        ...
        body (TrustedJWTKeysV4AaaPUT): API Gateway Trusted JWT Keys Resource
