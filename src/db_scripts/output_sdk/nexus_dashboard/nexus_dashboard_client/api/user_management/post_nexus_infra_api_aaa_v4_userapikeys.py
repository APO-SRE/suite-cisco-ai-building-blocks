...
from ...models.user_api_key_v4_aaa_post import UserAPIKeyV4AaaPOST
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: UserAPIKeyV4AaaPOST,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/nexus/infra/api/aaa/v4/userapikeys",
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = UserAPIKeyV4AaaGET.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Create a user API key
     ...
     Create a resource of type UserAPIKey

    Args:
        auth_cookie (Union[Unset, str]):
        cookie (Union[Unset, str]):
        x_csrf_token (Union[Unset, str]):
        body (UserAPIKeyV4AaaPOST): User API Key Resource
