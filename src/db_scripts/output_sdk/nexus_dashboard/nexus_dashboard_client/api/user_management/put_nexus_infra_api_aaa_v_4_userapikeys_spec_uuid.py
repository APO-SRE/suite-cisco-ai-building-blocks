...
from ...models.user_api_key_v4_aaa_put import UserAPIKeyV4AaaPUT
...
def sync_detailed(
    ...
    *,
    ...
    """Modify a user API key
     ...
     Modify a resource of type UserAPIKey
    ...
    Args:
        ...
        body (UserAPIKeyV4AaaPUT): User API Key Resource
