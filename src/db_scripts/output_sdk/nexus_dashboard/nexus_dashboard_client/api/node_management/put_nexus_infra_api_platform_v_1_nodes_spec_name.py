...
from ...models.node_v1_platform_put import NodeV1PlatformPUT
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/nexus/infra/api/platform/v1/nodes/{spec_name}",
    }
...
) -> Optional[Union[Any, NodeV1PlatformGET]]:
    if response.status_code == 200:
        response_200 = NodeV1PlatformGET.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, NodeV1PlatformGET]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (NodeV1PlatformPUT): Resource that represents a node in the cluster
