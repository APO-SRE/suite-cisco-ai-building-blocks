...
from ...models.network_storage_v1_platform_put import NetworkStorageV1PlatformPUT
...
def _get_kwargs(
    spec_name: str,
    *,
    body: NetworkStorageV1PlatformPUT,
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = NetworkStorageV1PlatformGET.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (NetworkStorageV1PlatformPUT): Network attached storage config
