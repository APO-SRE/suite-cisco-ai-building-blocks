...
from ...models.route_v1_platform_post import RouteV1PlatformPOST
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: RouteV1PlatformPOST,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/nexus/infra/api/platform/v1/routes",
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = RouteV1PlatformGET.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (RouteV1PlatformPOST): Resource that represents configuration for a network route, to
            be set on all nodes
