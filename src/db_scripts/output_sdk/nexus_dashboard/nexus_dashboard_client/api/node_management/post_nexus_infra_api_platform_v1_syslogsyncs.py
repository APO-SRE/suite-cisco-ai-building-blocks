...
from ...models.syslog_sync_v1_platform_post import SyslogSyncV1PlatformPOST
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: SyslogSyncV1PlatformPOST,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/nexus/infra/api/platform/v1/syslogsyncs",
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = SyslogSyncV1PlatformGET.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (SyslogSyncV1PlatformPOST): Resource that represents configuration for a remote
            syslog server
