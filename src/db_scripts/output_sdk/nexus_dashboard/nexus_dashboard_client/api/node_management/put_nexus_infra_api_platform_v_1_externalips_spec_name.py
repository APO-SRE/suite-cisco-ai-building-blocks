...
from ...models.external_ip_v1_platform_put import ExternalIpV1PlatformPUT
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/nexus/infra/api/platform/v1/externalips/{spec_name}",
    }
...
) -> Optional[Union[Any, ExternalIpV1PlatformGET]]:
    if response.status_code == 200:
        response_200 = ExternalIpV1PlatformGET.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ExternalIpV1PlatformGET]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (ExternalIpV1PlatformPUT): External IP config for external services
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ExternalIpV1PlatformGET]
    """
