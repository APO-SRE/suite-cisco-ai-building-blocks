...
from ...models.cluster_v1_platform_put import ClusterV1PlatformPUT
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/nexus/infra/api/platform/v1/clusters/{spec_name}",
    }
...
) -> Optional[Union[Any, ClusterV1PlatformGET]]:
    if response.status_code == 200:
        response_200 = ClusterV1PlatformGET.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ClusterV1PlatformGET]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (ClusterV1PlatformPUT): Resource that represents configuration of the cluster
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ClusterV1PlatformGET]
    """
