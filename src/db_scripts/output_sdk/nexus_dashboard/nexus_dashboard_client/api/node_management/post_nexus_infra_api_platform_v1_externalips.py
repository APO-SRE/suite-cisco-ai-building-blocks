...
from ...models.external_ip_v1_platform_post import ExternalIpV1PlatformPOST
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: ExternalIpV1PlatformPOST,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/nexus/infra/api/platform/v1/externalips",
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = ExternalIpV1PlatformGET.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (ExternalIpV1PlatformPOST): External IP config for external services
