...
from ...models.cluster_v2_platform_put import ClusterV2PlatformPUT
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/nexus/infra/api/platform/v2/clusters/{spec_name}",
    }
...
) -> Optional[Union[Any, ClusterV2PlatformGET]]:
    if response.status_code == 200:
        response_200 = ClusterV2PlatformGET.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ClusterV2PlatformGET]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (ClusterV2PlatformPUT): Resource that represents configuration of the cluster
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ClusterV2PlatformGET]
    """
