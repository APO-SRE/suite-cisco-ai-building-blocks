...
from ...models.syslog_sync_v1_platform_put import SyslogSyncV1PlatformPUT
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/nexus/infra/api/platform/v1/syslogsyncs/{spec_address}",
    }
...
) -> Optional[Union[Any, SyslogSyncV1PlatformGET]]:
    if response.status_code == 200:
        response_200 = SyslogSyncV1PlatformGET.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, SyslogSyncV1PlatformGET]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (SyslogSyncV1PlatformPUT): Resource that represents configuration for a remote syslog
            server
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, SyslogSyncV1PlatformGET]
    """
