...
from ...models.br_file_import_request import BrFileImportRequest
from ...types import Response


def _get_kwargs(
    *,
    body: BrFileImportRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/action/class/backuprestore/restore/file-import",
    }
...
def sync_detailed(
    *,
    ...
    """Import and validate a backup file to restore

     Import a backup file and perform the validation
