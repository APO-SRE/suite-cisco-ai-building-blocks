...
from ...models.post_api_action_class_backuprestore_backup_body import PostApiActionClassBackuprestoreBackupBody
from ...types import Response


def _get_kwargs(
    *,
    body: PostApiActionClassBackuprestoreBackupBody,
) -> dict[str, Any]:
