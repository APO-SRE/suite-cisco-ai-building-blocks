...
class ConfigActivityEvent:
    ...
    Attributes:
        ...
        object_type (Union[Unset, ModelsObjectType]): ObjectType defines an enumeration of types of objects.
        operation (Union[Unset, ModelsOperation]): Operation defines an enumeration of the types of operations or
            actions.
        parent_id (Union[Unset, str]): The object identifier of parent object.
        parent_type (Union[Unset, ModelsObjectType]): ObjectType defines an enumeration of types of objects.
