...
class ModelsPortEndpoint:
    ...
    Attributes:
        node_id (Union[Unset, str]): The unique identifier of the node.
        node_name (Union[Unset, str]): The user-defined name of the node.
        port_name (Union[Unset, str]): The canonical name of the port (E.g. Ethernet1_1).
    """
