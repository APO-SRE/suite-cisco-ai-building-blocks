...
T = TypeVar("T", bound="ConfigGetFabricNodesResponse")


@_attrs_define
class ConfigGetFabricNodesResponse:
    """The response returned to a request for the list of nodes in a specific fabric.

    Attributes:
        nodes (Union[Unset, list['ConfigNode']]): The list of nodes in the fabric
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config_get_fabric_nodes_response = cls(
            nodes=nodes,
        )

        config_get_fabric_nodes_response.additional_properties = d
        return config_get_fabric_nodes_response
