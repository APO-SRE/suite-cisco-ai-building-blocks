...
class ConfigAddFabricConnectionsRequest:
    """The request to add one or more connections to a specific fabric.

    Attributes:
        connections (Union[Unset, list['ModelsPortConnection']]): A list of connections to be added to the fabric.
    """
