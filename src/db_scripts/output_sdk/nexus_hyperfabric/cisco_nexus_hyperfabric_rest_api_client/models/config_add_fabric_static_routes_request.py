...
class ConfigAddFabricStaticRoutesRequest:
    """The request to add one or more static routes to a specific VRF in a fabric.

    Attributes:
        static_routes (Union[Unset, list['ModelsStaticRoutes']]): A list of static routes to be added to the VRF.
    """
