...
T = TypeVar("T", bound="ConfigSetFabricConnectionsRequest")


@_attrs_define
class ConfigSetFabricConnectionsRequest:
    """The request to update the list of connections in a specific fabric.

    Attributes:
        connections (Union[Unset, list['ModelsPortConnection']]): The list of connections for the fabric.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config_set_fabric_connections_request = cls(
            connections=connections,
        )

        config_set_fabric_connections_request.additional_properties = d
        return config_set_fabric_connections_request
