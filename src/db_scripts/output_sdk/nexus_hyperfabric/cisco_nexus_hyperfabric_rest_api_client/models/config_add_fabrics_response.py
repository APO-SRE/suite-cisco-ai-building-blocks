...
T = TypeVar("T", bound="ConfigAddFabricsResponse")


@_attrs_define
class ConfigAddFabricsResponse:
    """The response returned to a request to create a fabric.

    Attributes:
        fabrics (Union[Unset, list['ConfigFabric']]): A list of the newly created fabric.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config_add_fabrics_response = cls(
            fabrics=fabrics,
        )

        config_add_fabrics_response.additional_properties = d
        return config_add_fabrics_response
