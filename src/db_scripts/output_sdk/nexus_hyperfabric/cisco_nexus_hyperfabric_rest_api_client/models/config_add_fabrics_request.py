...
T = TypeVar("T", bound="ConfigAddFabricsRequest")


@_attrs_define
class ConfigAddFabricsRequest:
    """The request to create a fabric.

    Attributes:
        fabrics (Union[Unset, list['ConfigFabric']]): A list of one fabric to be created.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config_add_fabrics_request = cls(
            fabrics=fabrics,
        )

        config_add_fabrics_request.additional_properties = d
        return config_add_fabrics_request
