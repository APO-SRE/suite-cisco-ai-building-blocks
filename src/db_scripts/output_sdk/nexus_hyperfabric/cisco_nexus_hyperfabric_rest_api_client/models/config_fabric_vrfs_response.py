...
T = TypeVar("T", bound="ConfigFabricVrfsResponse")


@_attrs_define
class ConfigFabricVrfsResponse:
    """The response returned to a request for a list of VRFs in a fabric.

    Attributes:
        vrfs (Union[Unset, list['ModelsVrf']]): A list of VRFs in a fabric.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config_fabric_vrfs_response = cls(
            vrfs=vrfs,
        )

        config_fabric_vrfs_response.additional_properties = d
        return config_fabric_vrfs_response
