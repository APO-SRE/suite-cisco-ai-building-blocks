...
from ...models.config_add_fabric_vnis_request import ConfigAddFabricVnisRequest
...
def _get_kwargs(
    fabric_id: str,
    *,
    body: ConfigAddFabricVnisRequest,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        fabric_id (str):
        body (ConfigAddFabricVnisRequest): The request to add one or more VNIs to a specific
            fabric.
