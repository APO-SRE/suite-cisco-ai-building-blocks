...
from ...models.config_get_fabric_nodes_response import ConfigGetFabricNodesResponse
...
) -> Optional[Union[CommonRestError, ConfigGetFabricNodesResponse]]:
    if response.status_code == 200:
        response_200 = ConfigGetFabricNodesResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CommonRestError, ConfigGetFabricNodesResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CommonRestError, ConfigGetFabricNodesResponse]
    """
