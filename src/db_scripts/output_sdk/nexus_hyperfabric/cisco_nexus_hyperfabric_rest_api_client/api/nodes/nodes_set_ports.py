...
def sync_detailed(
    ...
    *,
    ...
    """Update the list of ports.
     ...
     Update the list of ports for a specific node in a fabric. This is a complete replacement of the
    ports for a node in a fabric.

    Args:
        fabric_id (str):
        node_id (str):
        body (ConfigSetPortsRequest): The request to update the list of ports of a specific node
            in a fabric.
