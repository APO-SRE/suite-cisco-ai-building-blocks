...
from ...models.config_add_fabric_connections_request import ConfigAddFabricConnectionsRequest
...
def _get_kwargs(
    fabric_id: str,
    *,
    body: ConfigAddFabricConnectionsRequest,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        fabric_id (str):
        body (ConfigAddFabricConnectionsRequest): The request to add one or more connections to a
            specific fabric.
