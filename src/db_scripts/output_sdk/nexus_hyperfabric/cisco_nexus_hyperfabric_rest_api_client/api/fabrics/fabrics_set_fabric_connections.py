...
from ...models.config_set_fabric_connections_request import ConfigSetFabricConnectionsRequest
...
def _get_kwargs(
    fabric_id: str,
    *,
    body: ConfigSetFabricConnectionsRequest,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Update the list of connections.
     ...
     Update the list of connections in a specific fabric. This is a complete replacement of the
    connections in a fabric. If no connections exist new ones will be created.

    Args:
        fabric_id (str):
        body (ConfigSetFabricConnectionsRequest): The request to update the list of connections in
            a specific fabric.
