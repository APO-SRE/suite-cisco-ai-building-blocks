...
if TYPE_CHECKING:
    from ..models.v2_map_hierarchy_children_children_children import V2MapHierarchyChildrenChildrenChildren


T = TypeVar("T", bound="V2MapHierarchyChildrenChildren")


@_attrs_define
class V2MapHierarchyChildrenChildren:
    """children location to given parent hierarchy

    Attributes:
        id (Union[Unset, str]): Campus unique identifier. Example: 8ebbcf5e-bad2-46c4-abbe-159dd0607b9d.
        parent_id (Union[Unset, str]): parent Id of current location type Example: 236b74fe-83c2-403b-acee-9cfa5345f960.
        ...
        children (Union[Unset, V2MapHierarchyChildrenChildrenChildren]): children location to given parent hierarchy
    """
    ...
    children: Union[Unset, "V2MapHierarchyChildrenChildrenChildren"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        children: Union[Unset, V2MapHierarchyChildrenChildrenChildren]
        if isinstance(_children, Unset):
            children = UNSET
        else:
            children = V2MapHierarchyChildrenChildrenChildren.from_dict(_children)

        v2_map_hierarchy_children_children = cls(
            id=id,
            parent_id=parent_id,
        ...
        v2_map_hierarchy_children_children.additional_properties = d
        return v2_map_hierarchy_children_children
