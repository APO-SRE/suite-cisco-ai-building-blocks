...
T = TypeVar("T", bound="V2MapFloorItemMapsItem")


@_attrs_define
class V2MapFloorItemMapsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v2_map_floor_item_maps_item = cls(
            name=name,
            source=source,
        ...
        v2_map_floor_item_maps_item.additional_properties = d
        return v2_map_floor_item_maps_item
