...
T = TypeVar("T", bound="V2MapHierarchyItemChildrenItemChildrenChildrenMapsItem")


@_attrs_define
class V2MapHierarchyItemChildrenItemChildrenChildrenMapsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v2_map_hierarchy_item_children_item_children_children_maps_item = cls(
            name=name,
            source=source,
        ...
        v2_map_hierarchy_item_children_item_children_children_maps_item.additional_properties = d
        return v2_map_hierarchy_item_children_item_children_children_maps_item
