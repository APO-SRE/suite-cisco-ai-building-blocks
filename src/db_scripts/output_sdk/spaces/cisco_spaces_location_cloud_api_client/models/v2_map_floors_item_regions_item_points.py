...
T = TypeVar("T", bound="V2MapFloorsItemRegionsItemPoints")


@_attrs_define
class V2MapFloorsItemRegionsItemPoints:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v2_map_floors_item_regions_item_points = cls(
            x=x,
            y=y,
            z=z,
            order=order,
        ...
        v2_map_floors_item_regions_item_points.additional_properties = d
        return v2_map_floors_item_regions_item_points
