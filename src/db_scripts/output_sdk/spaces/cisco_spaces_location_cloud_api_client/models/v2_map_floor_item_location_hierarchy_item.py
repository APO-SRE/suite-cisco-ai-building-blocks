...
T = TypeVar("T", bound="V2MapFloorItemLocationHierarchyItem")


@_attrs_define
class V2MapFloorItemLocationHierarchyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v2_map_floor_item_location_hierarchy_item = cls(
            id=id,
            name=name,
            type_=type_,
        ...
        v2_map_floor_item_location_hierarchy_item.additional_properties = d
        return v2_map_floor_item_location_hierarchy_item
