...
if TYPE_CHECKING:
    from ..models.v2_map_hierarchy_item_children_item_children_children import (
        V2MapHierarchyItemChildrenItemChildrenChildren,
    )


T = TypeVar("T", bound="V2MapHierarchyItemChildrenItemChildren")


@_attrs_define
class V2MapHierarchyItemChildrenItemChildren:
    ...
    Attributes:
        id (Union[Unset, str]): Location hierarchy id for the map element. Map element can be root, organization, group,
            cmx, meraki, campus, building, network, floor. Example: 8d2424bf-6877-405c-aa51-16b4ab280d40.
        parent_id (Union[Unset, str]): Parent Id of parent location of current location type. Defaulted to -1 for root
            level as root is on top of hierarchy. Example: 8ebbcf5e-bad2-46c4-abbe-159dd0607b9d.
        inferred_time_zone_id (Union[Unset, str]): Time zone id Example: 147: America/Los_Angeles.
        name (Union[Unset, str]): Name for given location level. Example: SJC-19.
        mongo_location_id (Union[Unset, int]): Mongo location id Example: 1220635.
        inferred_location_types (Union[Unset, list[Any]]): Location type in the hierarchy. This can be root,
            organization, group, cmx, meraki, campus, building, network, floor. Example: ["NETWORK", "BUILDING"].
        network_id (Union[Unset, str]): Legacy network ID for location. Example: 5d5893df-69d6-434c-afc2-fe46e4f55590.
        address (Union[Unset, str]): Address of given location. Example: 3600 Cisco Way, San Jose, California 95134,
            United States..
        total_area (Union[Unset, int]): Total area for location type Example: 10000.
        total_area_unit (Union[Unset, str]): Total area unit for location type Example: SQUARE_FEET.
        total_capacity (Union[Unset, int]): Total capacity for location type Example: 500.
        brand_name (Union[Unset, str]): Brand name of location entity. Example: Cisco.
        geo_location (Union[Unset, str]): Location coordinates of latitude and longitude Example:
            37.4071914,-121.9266002.
        ...
        hierarchy_map_sources (Union[Unset, list[Any]]): Array of hierarchy map sources. Possible values are CMX, PRIME,
            DNAC. Example: ["PRIME"].
        children (Union[Unset, V2MapHierarchyItemChildrenItemChildrenChildren]): children location to given parent
            hierarchy
    """
    ...
    children: Union[Unset, "V2MapHierarchyItemChildrenItemChildrenChildren"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        children: Union[Unset, V2MapHierarchyItemChildrenItemChildrenChildren]
        if isinstance(_children, Unset):
            children = UNSET
        else:
            children = V2MapHierarchyItemChildrenItemChildrenChildren.from_dict(_children)

        v2_map_hierarchy_item_children_item_children = cls(
            id=id,
            parent_id=parent_id,
        ...
        v2_map_hierarchy_item_children_item_children.additional_properties = d
        return v2_map_hierarchy_item_children_item_children
