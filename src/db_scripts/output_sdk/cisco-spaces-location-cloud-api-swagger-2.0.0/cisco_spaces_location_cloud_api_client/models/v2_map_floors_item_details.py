...
T = TypeVar("T", bound="V2MapFloorsItemDetails")


@_attrs_define
class V2MapFloorsItemDetails:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v2_map_floors_item_details = cls(
        ...
        v2_map_floors_item_details.additional_properties = d
        return v2_map_floors_item_details
