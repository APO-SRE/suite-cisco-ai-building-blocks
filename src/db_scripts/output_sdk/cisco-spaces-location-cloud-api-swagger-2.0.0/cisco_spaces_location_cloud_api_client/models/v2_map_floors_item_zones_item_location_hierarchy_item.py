...
T = TypeVar("T", bound="V2MapFloorsItemZonesItemLocationHierarchyItem")


@_attrs_define
class V2MapFloorsItemZonesItemLocationHierarchyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v2_map_floors_item_zones_item_location_hierarchy_item = cls(
            id=id,
            name=name,
            type_=type_,
        ...
        v2_map_floors_item_zones_item_location_hierarchy_item.additional_properties = d
        return v2_map_floors_item_zones_item_location_hierarchy_item
