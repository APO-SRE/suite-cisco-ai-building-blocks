...
T = TypeVar("T", bound="V2MapFloorsItemAccessPointsItemInterfacesItem")


@_attrs_define
class V2MapFloorsItemAccessPointsItemInterfacesItem:
    """
    Attributes:
        ...
        slot_number (Union[Unset, float]): slot number Example: 2.
    ...
    slot_number: Union[Unset, float] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v2_map_floors_item_access_points_item_interfaces_item = cls(
        ...
        v2_map_floors_item_access_points_item_interfaces_item.additional_properties = d
        return v2_map_floors_item_access_points_item_interfaces_item
