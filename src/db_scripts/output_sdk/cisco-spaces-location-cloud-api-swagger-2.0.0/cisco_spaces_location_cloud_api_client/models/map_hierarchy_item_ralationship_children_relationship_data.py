...
T = TypeVar("T", bound="MapHierarchyItemRalationshipChildrenRelationshipData")


@_attrs_define
class MapHierarchyItemRalationshipChildrenRelationshipData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        map_hierarchy_item_ralationship_children_relationship_data = cls(
            ancestors=ancestors,
            ancestor_ids=ancestor_ids,
        )

        map_hierarchy_item_ralationship_children_relationship_data.additional_properties = d
        return map_hierarchy_item_ralationship_children_relationship_data
