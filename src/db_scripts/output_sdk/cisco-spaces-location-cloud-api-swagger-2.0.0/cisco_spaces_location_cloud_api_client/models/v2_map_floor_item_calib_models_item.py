...
T = TypeVar("T", bound="V2MapFloorItemCalibModelsItem")


@_attrs_define
class V2MapFloorItemCalibModelsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v2_map_floor_item_calib_models_item = cls(
        ...
        v2_map_floor_item_calib_models_item.additional_properties = d
        return v2_map_floor_item_calib_models_item
