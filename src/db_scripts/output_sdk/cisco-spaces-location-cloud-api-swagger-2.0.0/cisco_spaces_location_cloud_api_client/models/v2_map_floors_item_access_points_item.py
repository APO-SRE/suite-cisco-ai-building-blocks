...
if TYPE_CHECKING:
    from ..models.v2_map_floors_item_access_points_item_interfaces_item import (
        V2MapFloorsItemAccessPointsItemInterfacesItem,
    )


T = TypeVar("T", bound="V2MapFloorsItemAccessPointsItem")


@_attrs_define
class V2MapFloorsItemAccessPointsItem:
    """
    Attributes:
        ...
        interfaces_remove (Union[Unset, list[Any]]): interfaces Example: ["f8d56d60-f6f3-4a6b-8f53-53acb7806914",
            "c1e04659-ea04-44f1-b130-aa287062e498", "6f3e4c3b-f2d6-41e4-ab3e-588e8bc8c8dc"].
        interfaces (Union[Unset, list['V2MapFloorsItemAccessPointsItemInterfacesItem']]):
    """
    ...
    interfaces_remove: Union[Unset, list[Any]] = UNSET
    interfaces: Union[Unset, list["V2MapFloorsItemAccessPointsItemInterfacesItem"]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        interfaces_remove: Union[Unset, list[Any]] = UNSET
        if not isinstance(self.interfaces_remove, Unset):
            interfaces_remove = self.interfaces_remove
        ...
        if interfaces_remove is not UNSET:
            field_dict["interfaces-remove"] = interfaces_remove
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        interfaces_remove = cast(list[Any], d.pop("interfaces-remove", UNSET))

        interfaces = []
        _interfaces = d.pop("interfaces", UNSET)
        for interfaces_item_data in _interfaces or []:
            interfaces_item = V2MapFloorsItemAccessPointsItemInterfacesItem.from_dict(interfaces_item_data)

            interfaces.append(interfaces_item)

        v2_map_floors_item_access_points_item = cls(
            ...
            z=z,
            angle=angle,
            interfaces_remove=interfaces_remove,
            interfaces=interfaces,
        )

        v2_map_floors_item_access_points_item.additional_properties = d
        return v2_map_floors_item_access_points_item
