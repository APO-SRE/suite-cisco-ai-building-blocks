...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/fabrics/{fabric_id}/connections/{connection_id}",
        "params": params,
    }
...
) -> Optional[Union[CommonRestError, ModelsPortConnection]]:
    if response.status_code == 200:
        response_200 = ModelsPortConnection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CommonRestError, ModelsPortConnection]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CommonRestError, ModelsPortConnection]
    """
