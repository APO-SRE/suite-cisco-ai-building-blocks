...
class ModelsAnnotation:
    """Annotation defines a typed name/value pair to store user-defined data including complex data such as JSON.

    Attributes:
        data_type (Union[Unset, ModelsDataType]): DataType defines an enumeration of data types.
        name (Union[Unset, str]): The user-defined name used to uniquely identify the annotation.
        value (Union[Unset, str]): The value of the annotation expressed as a string.
    """
