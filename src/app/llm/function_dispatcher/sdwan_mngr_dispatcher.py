...
def getBySeverity(severity_level: list, **kwargs):
    return Sdwan_mngrClient().getBySeverity(**{'severity-level': severity_level, **kwargs})
...
def getAppByUuid(app_uuid: str):
    return Sdwan_mngrClient().getAppByUuid(**{'app-uuid': app_uuid})
...
def createAppqoeActiveFlowIdDetails(deviceId: str, flow_id: str):
    return Sdwan_mngrClient().createAppqoeActiveFlowIdDetails(**{'deviceId': deviceId, 'flow-id': flow_id})
...
def createAppqoeFlowIdExpiredDetails(deviceId: str, flow_id: str):
    return Sdwan_mngrClient().createAppqoeFlowIdExpiredDetails(**{'deviceId': deviceId, 'flow-id': flow_id})
...
def createAppqoeVpnIdList(deviceId: str, vpn_id: str, **kwargs):
    return Sdwan_mngrClient().createAppqoeVpnIdList(**{'deviceId': deviceId, 'vpn-id': vpn_id, **kwargs})
...
def getBySeverities(severity_level: list, **kwargs):
    return Sdwan_mngrClient().getBySeverities(**{'severity-level': severity_level, **kwargs})
...
def getInterconnectAccount(interconnect_account_id: str):
    return Sdwan_mngrClient().getInterconnectAccount(**{'interconnect-account-id': interconnect_account_id})

@register('getAuditReport')
def getAuditReport(interconnect_type: str, **kwargs):
    return Sdwan_mngrClient().getAuditReport(**{'interconnect-type': interconnect_type, **kwargs})
...
def getGoogleCloudRouterAndAttachments(cloud_account_id: str, cloud_type: str, **kwargs):
    return Sdwan_mngrClient().getGoogleCloudRouterAndAttachments(**{'cloud-account-id': cloud_account_id, 'cloud-type': cloud_type, **kwargs})

@register('getAwsTransitGateways')
def getAwsTransitGateways(cloud_account_id: str, cloud_type: str, **kwargs):
    return Sdwan_mngrClient().getAwsTransitGateways(**{'cloud-account-id': cloud_account_id, 'cloud-type': cloud_type, **kwargs})

@register('getAzVirtualHubs')
def getAzVirtualHubs(cloud_account_id: str, cloud_type: str, **kwargs):
    return Sdwan_mngrClient().getAzVirtualHubs(**{'cloud-account-id': cloud_account_id, 'cloud-type': cloud_type, **kwargs})

@register('getAzVirtualWans')
def getAzVirtualWans(cloud_account_id: str, cloud_type: str, resource_group: str, **kwargs):
    return Sdwan_mngrClient().getAzVirtualWans(**{'cloud-account-id': cloud_account_id, 'cloud-type': cloud_type, 'resource-group': resource_group, **kwargs})

@register('getCloudConnectivityGateways')
def getCloudConnectivityGateways(cloud_account_id: str, cloud_type: str, **kwargs):
    return Sdwan_mngrClient().getCloudConnectivityGateways(**{'cloud-account-id': cloud_account_id, 'cloud-type': cloud_type, **kwargs})
...
def getCloudConnectivityGatewayCreateOptions(cloud_account_id: str, cloud_type: str, **kwargs):
    return Sdwan_mngrClient().getCloudConnectivityGatewayCreateOptions(**{'cloud-account-id': cloud_account_id, 'cloud-type': cloud_type, **kwargs})

@register('getInterconnectColors')
def getInterconnectColors(tunnel_type: str):
    return Sdwan_mngrClient().getInterconnectColors(**{'tunnel-type': tunnel_type})
...
def getInterconnectOnRampGatewayConnection(connection_name: str):
    return Sdwan_mngrClient().getInterconnectOnRampGatewayConnection(**{'connection-name': connection_name})

@register('getInterconnectMappingTags')
def getInterconnectMappingTags(cloud_account_id: str, cloud_type: str, **kwargs):
    return Sdwan_mngrClient().getInterconnectMappingTags(**{'cloud-account-id': cloud_account_id, 'cloud-type': cloud_type, **kwargs})
...
def getInterconnectDeviceLink(device_link_name: str):
    return Sdwan_mngrClient().getInterconnectDeviceLink(**{'device-link-name': device_link_name})
...
def getInterconnectCrossConnection(connection_name: str):
    return Sdwan_mngrClient().getInterconnectCrossConnection(**{'connection-name': connection_name})
...
def getInterconnectVirtualNetworkConnection(connection_name: str):
    return Sdwan_mngrClient().getInterconnectVirtualNetworkConnection(**{'connection-name': connection_name})
...
def getInterconnectLicenses(interconnect_account_id: str, interconnect_type: str, **kwargs):
    return Sdwan_mngrClient().getInterconnectLicenses(**{'interconnect-account-id': interconnect_account_id, 'interconnect-type': interconnect_type, **kwargs})
...
def getInterconnectGatewayImageNames(interconnect_type: str):
    return Sdwan_mngrClient().getInterconnectGatewayImageNames(**{'interconnect-type': interconnect_type})

@register('getInterconnectGatewayInstanceSizes')
def getInterconnectGatewayInstanceSizes(interconnect_type: str):
    return Sdwan_mngrClient().getInterconnectGatewayInstanceSizes(**{'interconnect-type': interconnect_type})

@register('getInterconnetGatewayTypes')
def getInterconnetGatewayTypes(interconnect_type: str):
    return Sdwan_mngrClient().getInterconnetGatewayTypes(**{'interconnect-type': interconnect_type})

@register('getInterconnectGateway')
def getInterconnectGateway(interconnect_gateway_name: str):
    return Sdwan_mngrClient().getInterconnectGateway(**{'interconnect-gateway-name': interconnect_gateway_name})
...
def getInterconnectGatewayCustomSettings(interconnect_account_id: str, interconnect_gateway_name: str):
    return Sdwan_mngrClient().getInterconnectGatewayCustomSettings(**{'interconnect-account-id': interconnect_account_id, 'interconnect-gateway-name': interconnect_gateway_name})

@register('getInterconnectIpTransit')
def getInterconnectIpTransit(interconnect_service_type: str, interconnect_type: str):
    return Sdwan_mngrClient().getInterconnectIpTransit(**{'interconnect-service-type': interconnect_service_type, 'interconnect-type': interconnect_type})
...
def getInterconnectServiceSwPkg(interconnect_account_id: str, interconnect_provider_name: str, interconnect_service_type: str, interconnect_service_vendor_name: str, **kwargs):
    return Sdwan_mngrClient().getInterconnectServiceSwPkg(**{'interconnect-account-id': interconnect_account_id, 'interconnect-provider-name': interconnect_provider_name, 'interconnect-service-type': interconnect_service_type, 'interconnect-service-vendor-name': interconnect_service_vendor_name, **kwargs})
...
def getInterconnectServices(interconnect_service_type: str, interconnect_service_vendor_name: str, interconnect_type: str):
    return Sdwan_mngrClient().getInterconnectServices(**{'interconnect-service-type': interconnect_service_type, 'interconnect-service-vendor-name': interconnect_service_vendor_name, 'interconnect-type': interconnect_type})

@register('getInterconnectGlobalSettings')
def getInterconnectGlobalSettings(interconnect_type: str):
    return Sdwan_mngrClient().getInterconnectGlobalSettings(**{'interconnect-type': interconnect_type})

@register('getInterconnectSshKeys')
def getInterconnectSshKeys(interconnect_account_id: str, interconnect_provider_name: str):
    return Sdwan_mngrClient().getInterconnectSshKeys(**{'interconnect-account-id': interconnect_account_id, 'interconnect-provider-name': interconnect_provider_name})
...
def getInterconnectBillingAccounts(interconnect_account_id: str, interconnect_type: str, **kwargs):
    return Sdwan_mngrClient().getInterconnectBillingAccounts(**{'interconnect-account-id': interconnect_account_id, 'interconnect-type': interconnect_type, **kwargs})
...
def getInterconnectPartnerPorts(cloud_type: str, interconnect_account_id: str, interconnect_type: str, **kwargs):
    return Sdwan_mngrClient().getInterconnectPartnerPorts(**{'cloud-type': cloud_type, 'interconnect-account-id': interconnect_account_id, 'interconnect-type': interconnect_type, **kwargs})
...
def getInterconnectPortSpeeds(connection_type: str, interconnect_account_id: str, interconnect_type: str, **kwargs):
    return Sdwan_mngrClient().getInterconnectPortSpeeds(**{'connection-type': connection_type, 'interconnect-account-id': interconnect_account_id, 'interconnect-type': interconnect_type, **kwargs})
...
def getInterconnectLocationInfo(interconnect_account_id: str, interconnect_type: str, **kwargs):
    return Sdwan_mngrClient().getInterconnectLocationInfo(**{'interconnect-account-id': interconnect_account_id, 'interconnect-type': interconnect_type, **kwargs})
...
def getInterconnectConfigGroupTopology(config_group_id: str, interconnect_type: str):
    return Sdwan_mngrClient().getInterconnectConfigGroupTopology(**{'config-group-id': config_group_id, 'interconnect-type': interconnect_type})

@register('getInterconnectDeviceLinkPortSpeeds')
def getInterconnectDeviceLinkPortSpeeds(interconnect_type: str):
    return Sdwan_mngrClient().getInterconnectDeviceLinkPortSpeeds(**{'interconnect-type': interconnect_type})

@register('getAvailableDevicesOrByCGId_1')
def getAvailableDevicesOrByCGId_1(interconnect_type: str, **kwargs):
    return Sdwan_mngrClient().getAvailableDevicesOrByCGId_1(**{'interconnect-type': interconnect_type, **kwargs})

@register('getInterconnectGatewayDevices')
def getInterconnectGatewayDevices(interconnect_type: str):
    return Sdwan_mngrClient().getInterconnectGatewayDevices(**{'interconnect-type': interconnect_type})

@register('getMonitoringInterconnectConnectedSites')
def getMonitoringInterconnectConnectedSites(interconnect_type: str, **kwargs):
    return Sdwan_mngrClient().getMonitoringInterconnectConnectedSites(**{'interconnect-type': interconnect_type, **kwargs})

@register('getMonitoringInterconnectDevices')
def getMonitoringInterconnectDevices(interconnect_type: str, **kwargs):
    return Sdwan_mngrClient().getMonitoringInterconnectDevices(**{'interconnect-type': interconnect_type, **kwargs})

@register('getMonitoringInterconnectGateways')
def getMonitoringInterconnectGateways(interconnect_type: str):
    return Sdwan_mngrClient().getMonitoringInterconnectGateways(**{'interconnect-type': interconnect_type})

@register('getInterconnectWidget')
def getInterconnectWidget(interconnect_type: str):
    return Sdwan_mngrClient().getInterconnectWidget(**{'interconnect-type': interconnect_type})
...
def getMultiCloudConfigGroupTopology(cloudType: str, config_group_id: str):
    return Sdwan_mngrClient().getMultiCloudConfigGroupTopology(**{'cloudType': cloudType, 'config-group-id': config_group_id})
...
def getEventFlowFromAppHop(deviceTraceId: int, direction: str, from_arg: str, timestamp: int, to: str, traceId: int, **kwargs):
    return Sdwan_mngrClient().getEventFlowFromAppHop(**{'deviceTraceId': deviceTraceId, 'direction': direction, 'from': from_arg, 'timestamp': timestamp, 'to': to, 'traceId': traceId, **kwargs})
...
def GetIpv6TrackerProfileParcelByParcelIdForTransport(ipv6_trackerId: str, transportId: str):
    return Sdwan_mngrClient().GetIpv6TrackerProfileParcelByParcelIdForTransport(**{'ipv6-trackerId': ipv6_trackerId, 'transportId': transportId})
...
def GetIpv6TrackerGroupProfileParcelByParcelIdForTransport(ipv6_trackergroupId: str, transportId: str):
    return Sdwan_mngrClient().GetIpv6TrackerGroupProfileParcelByParcelIdForTransport(**{'ipv6-trackergroupId': ipv6_trackergroupId, 'transportId': transportId})
...
def GetWanVpnInterfaceCellularAssociatedIpv6TrackerParcelByParcelIdForTransport(cellularId: str, ipv6_trackerId: str, transportId: str, vpnId: str):
    return Sdwan_mngrClient().GetWanVpnInterfaceCellularAssociatedIpv6TrackerParcelByParcelIdForTransport(**{'cellularId': cellularId, 'ipv6-trackerId': ipv6_trackerId, 'transportId': transportId, 'vpnId': vpnId})
...
def GetWanVpnInterfaceCellularAssociatedIpv6TrackerGroupParcelByParcelIdForTransport(cellularId: str, ipv6_trackergroupId: str, transportId: str, vpnId: str):
    return Sdwan_mngrClient().GetWanVpnInterfaceCellularAssociatedIpv6TrackerGroupParcelByParcelIdForTransport(**{'cellularId': cellularId, 'ipv6-trackergroupId': ipv6_trackergroupId, 'transportId': transportId, 'vpnId': vpnId})
...
def GetWanVpnInterfaceEthernetAssociatedIpv6TrackerParcelByParcelIdForTransport(ethernetId: str, ipv6_trackerId: str, transportId: str, vpnId: str):
    return Sdwan_mngrClient().GetWanVpnInterfaceEthernetAssociatedIpv6TrackerParcelByParcelIdForTransport(**{'ethernetId': ethernetId, 'ipv6-trackerId': ipv6_trackerId, 'transportId': transportId, 'vpnId': vpnId})
...
def GetWanVpnInterfaceEthernetAssociatedIpv6TrackerGroupParcelByParcelIdForTransport(ethernetId: str, ipv6_trackergroupId: str, transportId: str, vpnId: str):
    return Sdwan_mngrClient().GetWanVpnInterfaceEthernetAssociatedIpv6TrackerGroupParcelByParcelIdForTransport(**{'ethernetId': ethernetId, 'ipv6-trackergroupId': ipv6_trackergroupId, 'transportId': transportId, 'vpnId': vpnId})
